...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-callbacks/docs/can-view-callbacks.md"},"description":"Registered callbacks for behaviors \n","type":"module","title":"can-view-callbacks","types":[{"type":"Object","options":[]}],"name":"can-view-callbacks","parent":"can-infrastructure","package":{"author":{"email":"contact@bitovi.com","name":"Bitovi","url":"http://bitovi.com"},"bit-docs":{"dependencies":{"bit-docs-dev":"^0.0.3","bit-docs-generate-readme":"^0.0.8","bit-docs-glob-finder":"^0.0.5","bit-docs-js":"^0.0.3"},"glob":{"ignore":"node_modules/**/*","pattern":"**/*.{js,md}"},"parent":"can-view-callbacks","readme":{"apis":"./doc/apis.json"}},"bugs":{"url":"https://github.com/canjs/can-view-callbacks/issues"},"dependencies":{"can-namespace":"1.0.0","can-observation":"^3.3.0-pre.1","can-util":"^3.9.0-pre.4"},"description":"Registered callbacks for behaviors","devDependencies":{"done-serve":"^1.2.0","jshint":"^2.9.1","steal":"^1.2.10","steal-qunit":"^1.0.1","steal-tools":"^1.1.2","testee":"^0.6.1"},"directories":{},"dist":{"shasum":"0ca96e5321311feca4ed3f95ce441e1f6a166a19","tarball":"https://registry.npmjs.org/can-view-callbacks/-/can-view-callbacks-3.2.0.tgz"},"gitHead":"5d8bf22622104c92e7d498a615de0c05b792210d","homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs"],"main":"can-view-callbacks","maintainers":[{"email":"daff@neyeon.de","name":"daffl"},{"email":"justin@bitovi.com","name":"justinbmeyer"},{"email":"marshall@creativeideal.net","name":"marshallswain"},{"email":"matthew@matthewphillips.info","name":"matthewp"},{"email":"kphillips86@gmail.com","name":"phillipskevin"},{"email":"john@ardea.io","name":"sinjhin"}],"name":"can-view-callbacks","optionalDependencies":{},"repository":{"type":"git","url":"git://github.com/canjs/can-view-callbacks.git"},"scripts":{"build":"node build.js","develop":"done-serve --static --develop --port 8080","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"configDependencies":["live-reload"]},"version":"3.2.0"},"comment":" ","pathToRoot":".."};
</script>
</article>
