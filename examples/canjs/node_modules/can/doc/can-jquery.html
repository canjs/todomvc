	...
	<div class="page-type">
		<h1>can-jquery</h1>
			<ul class="title-social">
				...
				<li>
					<a class="github-button nav-social" href="https://github.com/canjs/can-jquery" data-show-count="true">Star</a>
				</li>
				
				
				<li>
					<a class="button-link" href="//github.com/canjs/can-jquery/edit/master/docs/can-jquery.md">Edit on GitHub</a>
				</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-jquery/docs/can-jquery.md"},"description":"Extensions to the event system so that can events and jQuery events are cross-bound. \n","type":"module","title":"can-jquery","types":[{"type":"jQuery"}],"name":"can-jquery","parent":"can-ecosystem","package":{"author":{"email":"contact@bitovi.com","name":"Bitovi","url":"http://bitovi.com"},"dependencies":{"can-dom-events":"^1.0.3","can-event":"^3.5.0-pre.2","can-event-dom-enter":"^1.0.1","can-util":"^3.9.0-pre.9","can-view-model":"^3.4.0-pre.0","jquery":"2.x - 3.x"},"description":"CanJS integrations for jQuery","devDependencies":{"can-component":"^3.2.0-pre.0","can-control":"^3.2.0-pre.0","can-define":"^1.3.0-pre.2","can-list":"^3.2.0-pre.2","can-map":"^3.3.0-pre.1","can-stache":"^3.2.0-pre.0","can-stache-bindings":"^3.4.0-pre.0","can-vdom":"^3.1.0-pre.1","jshint":"^2.9.1","steal":"^1.3.2","steal-qunit":"^1.0.1","steal-tools":"^1.2.0","testee":"^0.6.0"},"directories":{},"dist":{"shasum":"062dfa456e0250748daa56a25967c1b959c4c5d4","tarball":"https://registry.npmjs.org/can-jquery/-/can-jquery-3.2.1.tgz"},"gitHead":"6beb672b7cf8b15b51d93ac79a80b748b5781719","homepage":"https://canjs.com","keywords":["canjs"],"main":"can-jquery.js","maintainers":[{"email":"brad@bitovi.com","name":"bmomberger-bitovi"},{"email":"daff@neyeon.de","name":"daffl"},{"email":"justin@bitovi.com","name":"justinbmeyer"},{"email":"marshall@creativeideal.net","name":"marshallswain"},{"email":"matthew@matthewphillips.info","name":"matthewp"},{"email":"kphillips86@gmail.com","name":"phillipskevin"},{"email":"john@ardea.io","name":"sinjhin"}],"name":"can-jquery","optionalDependencies":{},"scripts":{"build":"node build.js","develop":"done-serve --static --develop --port 8080","document":"bit-docs","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"version":"3.2.1"},"signatures":[{"code":"jQuery","description":"\n\nImporting `can-jquery` will return the [jQuery object](http://api.jquery.com/jquery/) and wire up the event system.\n\n```js\nvar $ = require(\"can-jquery\");\n\nvar div = $(\"<div>\");\n\ndiv.on(\"inserted\", function(){\n\t// it inserted!\n});\n\n$(\"body\").append(div);\n```\n","params":[]}],"comment":" ","pathToRoot":".."};
</script>
</article>
