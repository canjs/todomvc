...
<a href="can-connect/constructor.hydrateList.html" title="Makes a list type object given raw data.">hydrateList</a> to convert raw data into
what's returned by <a href="can-connect/connection.getList.html" title="Gets a can-connect.List of instances.">connection.getList</a>.</p>
...
<p>The <a href="can-connect/constructor/constructor.list.html" title="Returns the data in its typed list form.">list</a> option is used
