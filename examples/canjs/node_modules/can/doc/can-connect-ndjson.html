...
<a href="can-connect/constructor.hydrateList.html" title="Makes a list type object given raw data.">hydrateList</a> methods on the <a href="can-connect.html" title="can-connect provides persisted data middleware. Use it to assemble powerful model layers for any JavaScript project.">can-connect</a> base connection to enable <a href="http://www.ndjson.org/">NDJSON</a> streaming using
...
<a href="can-connect.html#Otheruse" title="can-connect provides persisted data middleware. Use it to assemble powerful model layers for any JavaScript project.">modify the behaviors</a> in step 2 (can/map in particular)
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-ndjson/docs/can-connect-ndjson.md"},"description":"Get a list of data from an NDJSON service endpoint. \n","type":"module","title":"","types":[{"type":"connect.Behavior"}],"name":"can-connect-ndjson","parent":"can-ecosystem","package":{"author":{"email":"contact@bitovi.com","name":"Bitovi","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-connect-ndjson/issues"},"dependencies":{"can-connect":"^1.3.6","can-define":"^1.0.16","can-namespace":"^1.0.0","can-ndjson-stream":"^0.1.0","can-reflect":"^1.2.2","can-util":"^3.3.0","mocha":"^3.4.2","natives":"^1.1.0","request":"^2.81.0"},"description":"[![Greenkeeper badge](https://badges.greenkeeper.io/canjs/can-connect-ndjson.svg)](https://greenkeeper.io/)","devDependencies":{"can-stache":"^3.0.19","http-server":"^0.10.0","jshint":"^2.9.5","saucelabs":"^1.4.0","steal":"^1.0.5","steal-qunit":"^1.0.0","steal-tools":"^1.0.1","test-saucelabs":"0.0.1","testee":"^0.3.2"},"directories":{},"dist":{"integrity":"sha512-UHjEcToF1mjFsU0m06MRedtNKMnuF9oiv4eqez3vV1TIX4ltsI8UYciM0d9/Ayen54spSZcvZ/Z5AOiGXXYnNQ==","shasum":"854e8a2642fa981cb6e8805d796a46060ba0f94d","tarball":"https://registry.npmjs.org/can-connect-ndjson/-/can-connect-ndjson-0.1.1.tgz"},"gitHead":"5e7597c2266aca4a0c5d6bd42a5a117972b30b1f","homepage":"https://github.com/canjs/can-connect-ndjson#readme","keywords":[],"licenses":[{"type":"MIT","url":"http://opensource.org/licenses/mit-license.php"}],"main":"can-connect-ndjson","maintainers":[{"email":"bianca@bitovi.com","name":"bgando"},{"email":"cc2lufang@gmail.com","name":"ilufang"},{"email":"justin@bitovi.com","name":"justinbmeyer"},{"email":"matthew@matthewphillips.info","name":"matthewp"}],"name":"can-connect-ndjson","optionalDependencies":{},"repository":{"type":"git","url":"git://github.com/canjs/can-connect-ndjson.git"},"scripts":{"build":"node build.js","ci":"npm run build && npm run test && node ./test/test-sauce-labs.js","develop":"done-serve --static --develop --port 8080","http-server":"http-server -p 3000 --silent","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","test":"npm run jshint && node test/test.js","testee":"testee ./test/test.html --browsers chrome","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"configDependencies":["live-reload"],"main":"can-connect-ndjson","npmIgnore":["testee","generator-donejs","donejs-cli","steal-tools"]},"version":"0.1.1"},"signatures":[{"code":"ndjsonStream( baseConnection )","description":"\n\nOverwrites the [can-connect/connection.getListData] and\n[can-connect/constructor.hydrateList] methods on the [can-connect] base connection to enable [NDJSON](http://www.ndjson.org/) streaming using\n[`Fetch`](https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API) with\n[`ReadableStream`](https://developer.mozilla.org/en-US/docs/Web/API/ReadableStream)s. Falls back to default `baseConnection` in browsers that do not support `Fetch` and `ReadableStream`.\n","params":[]}],"comment":" ","pathToRoot":".."};
</script>
</article>
