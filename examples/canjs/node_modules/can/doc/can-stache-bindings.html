			...
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-stache-bindings">
						<img src="https://img.shields.io/badge/npm%20package-3.4.4-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache-bindings/docs/bindings.md"},"description":"\nProvides template event, one-way bindings, and two-way bindings.\n","type":"module","title":"","name":"can-stache-bindings","parent":"can-core","package":{"author":{"email":"contact@bitovi.com","name":"Bitovi","url":"http://bitovi.com"},"dependencies":{"can-cid":"^1.0.3","can-compute":"^3.3.1","can-event":"^3.5.0","can-event-dom-enter":"^1.0.0","can-event-dom-radiochange":"^1.0.0","can-observation":"^3.3.0-pre.1","can-reflect":"^1.2.1","can-simple-map":"^3.3.0-pre.2","can-stache":"^3.2.0-pre.0","can-stache-key":"^0.0.2","can-symbol":"^1.0.0","can-types":"^1.1.0","can-util":"^3.9.0","can-view-callbacks":"^3.2.0-pre.0","can-view-live":"^3.2.0-pre.0","can-view-model":"^3.4.0-pre.0","can-view-scope":"^3.3.0-pre.3"},"description":"Default binding syntaxes for can-stache","devDependencies":{"bit-docs":"0.0.7","can-define":"^1.3.0-pre.1","can-list":"^3.2.0-pre.1","can-map":"^3.3.1","can-vdom":"^3.1.0","can-view-nodelist":"^3.1.0","jshint":"^2.9.1","steal":"^1.2.9","steal-qunit":"^1.0.1","steal-tools":"^1.1.2","testee":"^0.6.1"},"directories":{},"dist":{"shasum":"cd6cf7c009937ee2b1f91d68e669c3c71d7a5fdf","tarball":"https://registry.npmjs.org/can-stache-bindings/-/can-stache-bindings-3.4.4.tgz"},"gitHead":"bdd676b6eb8a39546c5d285578ebdaf70d34c82d","homepage":"http://canjs.com","keywords":["canjs","donejs"],"main":"can-stache-bindings","maintainers":[{"email":"christopher.andrejewski@gmail.com","name":"andrejewski"},{"email":"brad@bitovi.com","name":"bmomberger-bitovi"},{"email":"slithytove2@gmail.com","name":"christopherjbaker"},{"email":"daff@neyeon.de","name":"daffl"},{"email":"justin@bitovi.com","name":"justinbmeyer"},{"email":"marshall@creativeideal.net","name":"marshallswain"},{"email":"matthew@matthewphillips.info","name":"matthewp"},{"email":"mick.mc.13@gmail.com","name":"mickmcgrath13"},{"email":"kphillips86@gmail.com","name":"phillipskevin"},{"email":"john@ardea.io","name":"sinjhin"}],"name":"can-stache-bindings","optionalDependencies":{},"scripts":{"build":"node build.js","document":"bit-docs","jshint":"jshint test/ ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"main":"can-stache-bindings"},"version":"3.4.4"},"comment":" ","pathToRoot":".."};
</script>
</article>
