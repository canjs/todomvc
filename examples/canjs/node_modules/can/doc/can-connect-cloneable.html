...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Makes mutable clones of <a href="can-connect.html" title="can-connect provides persisted data middleware. Use it to assemble powerful model layers for any JavaScript project.">can-connect</a>’d maps. Changes to the clone save back to the original; likewise, changes to the original propagate to the clone.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-cloneable/docs/can-connect-cloneable.md"},"description":"Makes mutable clones of [can-connect]’d maps. Changes to the clone save back to the original; likewise, changes to the original propagate to the clone. \n","type":"module","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-connect-cloneable","parent":"can-ecosystem","package":{"author":{"name":"Bitovi"},"bugs":{"url":"https://github.com/canjs/can-connect-cloneable/issues"},"dependencies":{"can-connect":"^1.5.0-pre.0","can-util":"^3.9.0-pre.4"},"description":"Allows you to make mutable clones of can-connected maps and save changes back to the original","devDependencies":{"can-define":"^1.2.0-pre.4","can-fixture":"^1.1.0-pre.0","can-list":"^3.1.0-pre.9","can-map":"^3.1.0-pre.10","can-map-define":"^3.1.0-pre.0","done-serve":"^1.3.0","donejs-cli":"^1.0.1","jshint":"^2.9.1","steal":"^1.2.4","steal-qunit":"^1.0.0","steal-tools":"^1.1.2","testee":"^0.6.0"},"directories":{"doc":"docs","test":"test"},"dist":{"integrity":"sha512-WiT/3fciLFvUlB+f84Hf7CoTlaED3n14PkDDeX0Akz3FXVe7/qnJdTEMTYtXVBdJDugHFq+Wt9N0k+8USh9CvA==","shasum":"fdbf4f2ed85c2d179c642419915a92af98da44d8","tarball":"https://registry.npmjs.org/can-connect-cloneable/-/can-connect-cloneable-0.2.0.tgz"},"gitHead":"56383c52e76e9c20167c48fddadd7173f2ad70eb","homepage":"https://github.com/canjs/can-connect-cloneable","keywords":["clone","plugin","canjs"],"license":"MIT","main":"can-connect-cloneable","maintainers":[{"email":"justin@bitovi.com","name":"justinbmeyer"},{"email":"kyle@kylegifford.com","name":"kylegifford"},{"email":"matthew@matthewphillips.info","name":"matthewp"},{"email":"kphillips86@gmail.com","name":"phillipskevin"}],"name":"can-connect-cloneable","optionalDependencies":{},"repository":{"type":"git","url":"git://github.com/canjs/can-connect-cloneable.git"},"scripts":{"build":"node build.js","develop":"done-serve --static --develop --port 8080","document":"documentjs","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm run build && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"system":{"configDependencies":["live-reload"],"npmAlgorithm":"flat"},"version":"0.2.0"},"signatures":[{"code":"makeCloneable(Type)","description":"\n\nMakes `Type` cloneable by giving its instances a `clone` method.\n\n```javascript\nvar DefineMap = require(\"can-define/map/map\");\nvar makeCloneable = require(\"can-connect-cloneable\");\n\nvar MyDefineMap = DefineMap.extend({ name: \"string\" });\nmakeCloneable(MyDefineMap);\n\nvar original = new MyDefineMap({ name: \"Kyle\" });\nvar clone = original.clone();\nclone.name; // -> \"Kyle\"\n```\n","params":[{"types":[{"type":"can-map"},{"type":"can-define/map/map"}],"name":"Type","description":"The DefineMap or CanMap you want to make clonable\n\n"}]}],"_curParam":{"types":[{"type":"can-map"},{"type":"can-define/map/map"}],"name":"Type","description":"The DefineMap or CanMap you want to make clonable\n\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
