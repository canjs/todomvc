...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stache/docs/stache.md"},"description":"Live binding Mustache and Handlebars-compatible templates. \n","type":"module","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-stache","parent":"can-core","release":"2.1","package":{"author":{"email":"contact@bitovi.com","name":"Bitovi","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-stache/issues"},"dependencies":{"can-compute":"^3.3.0-pre.1","can-namespace":"1.0.0","can-observation":"^3.3.0-pre.1","can-reflect":"^1.1.0-pre.2","can-route":"^3.2.0-pre.0","can-stache-key":"^0.0.2","can-symbol":"^1.0.0-pre.0","can-util":"^3.9.0-pre.4","can-view-callbacks":"^3.2.0-pre.0","can-view-live":"^3.2.0-pre.0","can-view-nodelist":"^3.1.0-pre.0","can-view-parser":"^3.4.0-pre.0","can-view-scope":"^3.3.0-pre.3","can-view-target":"^3.1.0-pre.0"},"description":"Live binding handlebars templates","devDependencies":{"can-define":"^1.3.0-pre.1","can-event":"^3.5.0-pre.2","can-list":"^3.2.0-pre.1","can-map":"^3.3.0-pre.1","can-vdom":"^3.1.0-pre.0","done-serve":"^0.2.5","jshint":"^2.9.4","steal":"^1.0.5","steal-benchmark":"^0.0.1","steal-qunit":"^1.0.0","steal-tools":"^1.0.1","testee":"^0.6.1"},"directories":{},"dist":{"shasum":"7fe45fcfb8c86870151b152a9c8891379ac4d016","tarball":"https://registry.npmjs.org/can-stache/-/can-stache-3.2.0.tgz"},"gitHead":"62d548b6204a5c5aef90ced27e4b1f4ff737b689","homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs"],"main":"can-stache","maintainers":[{"email":"john@ardea.io","name":"sinjhin"},{"email":"slithytove2@gmail.com","name":"christopherjbaker"},{"email":"kern.julian.86@googlemail.com","name":"juk3"},{"email":"brad@bitovi.com","name":"bmomberger-bitovi"},{"email":"kphillips86@gmail.com","name":"phillipskevin"},{"email":"justin@bitovi.com","name":"justinbmeyer"},{"email":"matthew@matthewphillips.info","name":"matthewp"},{"email":"daff@neyeon.de","name":"daffl"}],"name":"can-stache","optionalDependencies":{},"repository":{"type":"git","url":"git://github.com/canjs/can-stache.git"},"scripts":{"build":"node build.js","develop":"done-serve --static --develop --port 8080","document":"bit-docs","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"version":"3.2.0"},"link":"../docco/view/stache/mustache_core.html docco","test":"can/view/stache/test/test.html","plugin":"can/view/stache","download":"http://canjs.us/release/latest/can.stache.js","signatures":[{"code":"stache(template)","description":"\n\nProcesses the template and returns a [can-stache.renderer renderer function].\nUse [steal-stache] to import template renderer functions with [http://stealjs.com StealJS].\n","params":[{"types":[{"type":"String"}],"name":"template","description":"The text of a stache template.\n"}],"returns":{"types":[{"type":"can-stache.renderer"}],"description":"A [can-stache.renderer renderer] function that returns a live document fragment\nthat can be inserted in the page.\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"template","description":"The text of a stache template.\n"},"_curReturn":{"types":[{"type":"can-stache.renderer"}],"description":"A [can-stache.renderer renderer] function that returns a live document fragment\nthat can be inserted in the page.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
