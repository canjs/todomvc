			...
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/react-view-model">
						<img src="https://img.shields.io/badge/npm%20package-0.5.5-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
...
<pre><code class="language-jsx">export default reactViewModel( 'AppComponent', ViewModel, (viewModel) =&gt; (&lt;div&gt;{viewModel.name}&lt;/div&gt;) );
  ...
  <div class="returns">
    ...
    <section class="body">
    <h2>Use</h2>
<p>An example application using the ViewModel to create an extra prop, who's value is derived from other props.</p>
