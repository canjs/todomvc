	...
	<div class="page-type">
		<h1>matched</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-route/edit/master/can-route.js#L850">Edit on GitHub</a>
				</li>
...
<script type="text/javascript">
  window.docObject = {"name":"can-route.matched","type":"function","parent":"can-route.static","src":{"line":849,"codeLine":870,"path":"node_modules/can-route/can-route.js"},"description":"A compute representing the currently matched route. ","title":"matched","signatures":[{"code":"route.matched()","description":"","params":[],"returns":{"types":[{"type":"String"}],"description":"The currently matched route.\n"}}],"_curReturn":{"types":[{"type":"String"}],"description":"The currently matched route.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
