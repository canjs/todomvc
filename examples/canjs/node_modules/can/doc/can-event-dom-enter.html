...
<script type="text/javascript">
  window.docObject = {"name":"can-event-dom-enter","type":"module","parent":"can-infrastructure","src":{"line":31,"codeLine":55,"path":"node_modules/can-event-dom-enter/can-event-dom-enter.js"},"description":"\nWatch for when enter keys are pressed on a DomEventTarget.\n","title":"","types":[{"type":"events"}],"pathToRoot":".."};
</script>
</article>
