...
<p>If the <a href="can-zone.html" title="">can-zone</a> library has been imported, <code>getStore</code> returns the <code>CanZone.current.data</code> object.</p>
...
<p>If the <a href="can-zone.html" title="">can-zone</a> library has NOT been imported, <code>getStore</code> returns the internal <a href="can-zone-storage.data.html" title="Implement Zone-safe memory-based storage">data</a> object.</p>
<pre><code class="language-js">var zoneStorage = require(&quot;can-zone-storage&quot;);
var store = zoneStorage.getStore();
