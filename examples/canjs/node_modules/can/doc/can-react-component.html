			...
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-react-component">
						<img src="https://img.shields.io/badge/npm%20package-0.1.5-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
...
<div class="signature">
  ...
  <pre><code class="language-javascript">export default canReactComponent( 'AppComponent', CanComponent.extend({ ... }) )
</code></pre>
<p>Since the component doesn’t produce DOM artifacts of its own, you won’t end up with any wrapper divs or anything to worry about, but in react-device-tools you will see the component with the <code>displayName</code> (or defaults to <code>CanComponentWrapper</code>) in the tree.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>displayName</b> <code>{String}</code>: <p>The name of the created component</p>
</li>
        
          <li><b>CanComponent</b> <code>{CanComponent}</code>: <p>Any Can component</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-react-component/docs/can-react-component.md"},"description":"Create a React component out of a [can-component]. \n","title":"can-react-component","name":"can-react-component","parent":"can-ecosystem","type":"function","package":{"author":{"email":"contact@bitovi.com","name":"Bitovi","url":"http://bitovi.com"},"bit-docs":{"dependencies":{"bit-docs-dev":"^0.0.3","bit-docs-generate-readme":"^0.0.8","bit-docs-glob-finder":"^0.0.5","bit-docs-js":"^0.0.3"},"glob":{"ignore":"node_modules/**/*","pattern":"docs/**/*.{js,md}"},"readme":{"apis":"./docs/apis.json"}},"bugs":{"url":"https://github.com/canjs/can-react-component/issues"},"dependencies":{"can-util":"^3.7.0","can-view-scope":"^3.1.1"},"description":"Create a React component out of a CanComponent.","devDependencies":{"babel-eslint":"^7.2.3","bit-docs":"0.0.7","can-component":"^3.0.7","can-define":"^1.0.25","can-stache":"^3.0.24","done-serve":"^1.3.0","eslint":"^3.18.0","eslint-plugin-react":"^7.0.1","react":"^15.4.2","react-dom":"^15.4.2","steal":"^1.5.2","steal-builtins":"^1.0.0","steal-qunit":"^1.0.0","steal-tools":"^1.3.5","testee":"^0.6.0"},"directories":{},"dist":{"integrity":"sha512-BnUxTG7kp5oNhZs6X8TGjZTqXcepivmRkx7qPwr9AiLZGfAR/8bsgTCu83g7ikiFSEPeLkXG+kFybmrmEVHRjQ==","shasum":"30bc5e1577dddf9b10042fa6a04d40ce6cd62b0a","tarball":"https://registry.npmjs.org/can-react-component/-/can-react-component-0.1.5.tgz"},"gitHead":"d0b197e7eef46d09c65693373e71fa76a1e25315","homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs","react"],"main":"can-react-component","maintainers":[{"email":"slithytove2@gmail.com","name":"christopherjbaker"}],"name":"can-react-component","optionalDependencies":{},"peerDependencies":{"react":"^15.4.2"},"repository":{"type":"git","url":"git://github.com/canjs/can-react-component.git"},"scripts":{"build":"node build.js","develop":"done-serve --static --develop --port 8080","document":"bit-docs","eslint":"eslint \"**/*.js\" --ignore-pattern \"dist\" --ignore-pattern \"node_modules\"","postversion":"git push --tags && git checkout master && git branch -D release && git push","prepublish":"npm run build","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish","test":"npm run eslint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"configDependencies":["live-reload"],"main":"can-react-component","npmIgnore":["babel-eslint","bit-docs","done-serve","eslint","eslint-plugin-react","testee"]},"version":"0.1.5"},"signatures":[{"code":"canReactComponent( displayName, CanComponent )","description":"\n\n```javascript\nexport default canReactComponent( 'AppComponent', CanComponent.extend({ ... }) )\n```\n\nSince the component doesn’t produce DOM artifacts of its own, you won’t end up with any wrapper divs or anything to worry about, but in react-device-tools you will see the component with the `displayName` (or defaults to `CanComponentWrapper`) in the tree.\n","params":[{"types":[{"type":"String"}],"name":"displayName","description":"The name of the created component"},{"types":[{"type":"CanComponent"}],"name":"CanComponent","description":"Any Can component\n"}],"returns":{"types":[{"type":"ReactComponent"}],"description":"A React component\n"}}],"_curParam":{"types":[{"type":"CanComponent"}],"name":"CanComponent","description":"Any Can component\n"},"_curReturn":{"types":[{"type":"ReactComponent"}],"description":"A React component\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
