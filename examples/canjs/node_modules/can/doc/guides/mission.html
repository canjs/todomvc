	...
	<div class="page-type">
		<h1>Mission</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/canjs/edit/master/docs/can-guides/introduction/mission.md">Edit on GitHub</a>
				</li>
...
<a href="https://medium.freecodecamp.com/javascript-fatigue-fatigue-66ffb619f6ce#.n5tt0jqhf">never-ending stream</a> of <a href="https://www.allenpike.com/2015/javascript-framework-fatigue/">hot new JavaScript frameworks</a>
...
context.</p>
<p><strong>In 2009</strong>, <a href="https://jquery.com">jQuery</a> began to dominate JavaScript development.
...
<p>For teams upgrading to <code>3.0</code>, we created multiple <a href="../migrate-3.html" title="This guide walks you through the step-by-step process to upgrade a 2.x app to CanJS 3.">migration paths</a>
...
<a href="../can-define-stream.html" title="Add useful stream conversion methods to a supplied map or list constructor using a stream interface such as can-stream-kefir.">functional reactive programming techniques</a>.</li>
</ul>
...
<li>Experiments like <a href="../can-stream-kefir.html" title="Convert observable values into streams. Kefir is used to provide the stream functionality.">can-stream-kefir</a>, where a lot of innovation happens, can be
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"docs/can-guides/introduction/mission.md"},"description":"Learn about CanJS’s mission, why it matters, and how we’ve worked (and will keep working) to accomplish it.\n\n\n","name":"guides/mission","title":"Mission","type":"page","parent":"about","order":0,"comment":" ","pathToRoot":"../.."};
</script>
</article>
