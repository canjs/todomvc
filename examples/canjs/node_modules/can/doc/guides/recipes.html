...
CanJS 3.5.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="page"
							href="contributing/api-design-guidelines.html"
					...
					<li class="
           						...
           						">
						<a class="page"
							href="contributing/new-package.html"
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>recipes</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/canjs/edit/master/docs/can-guides/commitment/recipes/recipes.md">Edit on GitHub</a>
				</li>
    ...
    <p>A listing of small examples that are useful for learning CanJS.</p>
...
<section class="on-this-page-table">
    ...
    <section class="body">
    <h2>Credit Card</h2>
<p>The <a href="recipes/credit-card-simple.html" title="This guide walks through building a very simple credit card payment form.  It uses Stripe.js v2 API to create a token
which can be used to create a charge.  It also performs
simple validation on the payment form values.">Credit Card Guide (Simple)</a>  walks through building
a simple credit card payment form with Stripe. It also performs
simple validation on the payment form values.</p>
<p><img src="https://user-images.githubusercontent.com/78602/27451508-d86e9bd8-5754-11e7-954b-a812e1ed63b1.png" alt="Credit Card App" /></p>
<h2>File Navigator</h2>
<p>The <a href="recipes/file-navigator-simple.html" title="This guide walks you through building a simple file navigation widget.  It takes about 25 minutes to complete.  It was written with
CanJS 3.4. Checkout the file-navigator-advanced
for an example that makes AJAX requests for its data and uses can-component.">File Navigator Guide (Simple)</a> walks through building a simple navigation
widget where you can open and close folders.</p>
<p>The <a href="recipes/file-navigator-advanced.html" title="This guide walks you through building a file navigation widget.  It takes about 45 minutes to complete.  It was written with
CanJS 3.4. Checkout the file-navigator-simple
for an easier example that produces similar functionality.">File Navigator Guide (Advanced)</a> walks through a navigation widget that uses
<a href="../can-connect.html" title="can-connect provides persisted data middleware. Use it to assemble powerful model layers for any JavaScript project.">can-connect</a> to load the data for a folder from a simulated service layer.</p>
<p><img src="https://cloud.githubusercontent.com/assets/78602/22888969/273617ca-f1cd-11e6-922f-28bd5514b3dd.jpeg" alt="File Navigator" /></p>
<h2>TodoMVC with StealJS</h2>
<p>The <a href="recipes/todomvc-with-steal.html" title="This guide walks through building TodoMVC with StealJS.">TodoMVC with StealJS</a> guide builds the TodoMVC application, like the <a href="todomvc.html" title="This guide will walk you through building a slightly modified version of TodoMVC with CanJS’s Core libraries and can-fixture. It takes about 1 hour to complete.">TodoMVC Guide</a>, but using <a href="https://stealjs.com">StealJS</a> to load modules.  It is designed to be done in a classroom-like setting and includes links
to keynote and powerpoint presentations for each section.</p>
<h2>Weather Report</h2>
<p>The <a href="recipes/weather-report-simple.html" title="This guide walks you through building a simple weather report widget.  It takes about 25 minutes to complete.  It was written with
CanJS 3.5.">Weather Report Guide (Simple)</a> walks through building a 10 day forecast widget
using YQL. The <a href="recipes/weather-report-advanced.html" title="This guides you through extending the Simple Weather Report Guide to remove imperative code and automatically look up the user’s location using the
browser’s geolocation API.  Both of these will be done with event streams.
This guide continues where the Simple Weather Report Guide left off.  It takes about 25 minutes to complete.  It was written with CanJS 3.8.">Weather Report Guide (Advanced)</a> extends the simple widget to
remove imperative code and automatically lookup the users location using the
browser's <a href="https://developer.mozilla.org/en-US/docs/Web/API/Geolocation/Using_geolocation">geolocation</a> with
event streams.</p>
<p><img src="../../docs/can-guides/commitment/recipes/weather-report/weather-report.png" alt="Weather Report" /></p>
...
drag/drop events. It shows using custom attributes and custom events.  This guide takes
an hour to complete.">Playlist Editor (Advanced)</a> shows how to use YouTube's API to search for videos and make a playlist.  This
makes authenticated requests with OAuth2. It uses <a href="https://jquerypp.com">jQuery++</a> for
drag/drop events. It shows using custom attributes and custom events.</p>
<p><img src="https://user-images.githubusercontent.com/78602/27451781-ea3ed3d6-5755-11e7-8dd8-c4e83bc8aa90.png" alt="Playlist Editor" /></p>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"docs/can-guides/commitment/recipes/recipes.md"},"description":"A listing of small examples that are useful for learning CanJS.\n\n","name":"guides/recipes","title":"recipes","type":"page","parent":"guides","order":3,"comment":" ","pathToRoot":"../.."};
</script>
</article>
