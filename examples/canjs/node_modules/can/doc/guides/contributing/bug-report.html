	...
	<div class="page-type">
		<h1>Bug Report</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/canjs/edit/master/docs/can-guides/contribute/bug-report.md">Edit on GitHub</a>
				</li>
...
<ul>
<li>Small examples using tools like JS&nbsp;Bin. You can clone the following <a href="https://jsbin.com/losoceranu/1/edit?html,js,output">CanJS bin</a> that includes everything in CanJS. Make
sure it’s pointing at the same version of CanJS you are using.</li>
<li>Breaking unit tests (optional). See <a href="code.html" title="Learn how contribute a code change to CanJS. Read the new-package package guide on how to make a plugin to CanJS.">Code</a>.</li>
...
<p>The <a href="https://donejs.com/About.html#team">core team</a> reviews issues
...
<li>You can always hire <a href="https://www.bitovi.com">Bitovi</a> or a contributor to make the change.</li>
</ul>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"docs/can-guides/contribute/bug-report.md"},"description":"Learn how to submit a bug report. \n","name":"guides/contributing/bug-report","title":"Bug Report","type":"page","parent":"guides/contribute","comment":" ","pathToRoot":"../../.."};
</script>
</article>
