...
<p><a class="jsbin-embed" href="https://jsbin.com/xiponom/16/embed?output">JS Bin on jsbin.com</a></p>
...
<li><p>Use <a href="../../can-stache-bindings.event.html" title="Respond to events on elements or component ViewModels.">($EVENT)</a> to listen to an event on an element and call a method in <code>can-stache</code>.  For example, the following calls <code>sayHi()</code> when the <code>&lt;div&gt;</code> is clicked.</p>
...
<h3>What you need to know</h3>
<ul>
<li><p>Use <a href="../../can-stache-bindings.twoWay.html" title="Two-way bind a value in the viewModel or the element to the parent scope.">{($value)}</a> to setup a two-way binding in <code>can-stache</code>.  For example, the following keeps <code>searchQuery</code> and the input's <code>value</code> in sync:</p>
<pre><code class="language-html">&lt;input {($value)}=&quot;searchQuery&quot;/&gt;
</code></pre></li>
...
<pre><code class="language-html">($draginit)=&quot;startedDrag(%arguments[1])&quot;
</code></pre></li>
...
<p><span line-highlight='22,only'></span>
Update the <strong>JavaScript</strong> tab to:</p>
<pre><code class="language-js">var PlaylistVM = can.DefineMap.extend(&quot;PlaylistVM&quot;, {
  init: function() {
    var self = this;
...
<pre><code class="language-html">($dropon)=&quot;addVideo(%arguments[2])&quot;
</code></pre></li>
...
<li><p>Access the event object in a <a href="../../can-stache-bindings.event.html" title="Respond to events on elements or component ViewModels.">(event)</a> with <code>%event</code>, like:</p>
<pre><code class="language-html">($sortableinsertat)=&quot;addVideo(%event.index, %event.dragData)&quot;
</code></pre></li>
...
<li><p>Use <a href="../../can-stache-bindings.toChild.html" title="One-way bind a value in the parent scope to the ViewModel.">{$disabled}</a> to make an input disabled, like:</p>
<pre><code class="language-html">&lt;button {$disabled}=&quot;createPlaylistPromise.isPending()&quot;&gt;...
</code></pre></li>
