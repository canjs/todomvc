...
<p><a class="jsbin-embed" href="https://jsbin.com/hawicej/5/embed?output">JS Bin on jsbin.com</a></p>
...
<h3>What you need to know</h3>
<ul>
<li><p>Use <a href="../../can-stache-bindings.twoWay.html" title="Two-way bind a value in the viewModel or the element to the parent scope.">{($value)}</a> to setup a two-way binding<br />
...
<pre><code class="language-html">&lt;input {($value)}=&quot;email&quot;/&gt;
</code></pre></li>
...
<pre><code class="language-html">&lt;div ($click)=&quot;doSomething(%event)&quot;&gt; ... &lt;/div&gt;
</code></pre>
...
<pre><code class="language-html">&lt;button {$disabled}=&quot;isCardInvalid&quot;&gt;...
</code></pre></li>
</ul>
<h3>The solution</h3>
<p>Update the <strong>HTML</strong> tab to:</p>
<pre><code class="language-html">&lt;script type='text/stache' id=&quot;payment-view&quot;&gt;
  &lt;form ($submit)=&quot;pay(%event)&quot;&gt;
    ...
    &lt;button {$disabled}=&quot;isCardInvalid&quot;&gt;Pay ${{amount}}&lt;/button&gt;
