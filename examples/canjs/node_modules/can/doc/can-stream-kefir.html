...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-stream-kefir/docs/can-stream-kefir.md"},"description":"Convert observable values into streams. [Kefir](https://rpominov.github.io/kefir/) is used to provide the stream functionality. \n","type":"module","title":"can-stream-kefir","types":[{"type":"Object","options":[],"description":"\n\n  The `can-stream-kefir` module exports methods useful for converting observable values like [can-compute]s\n  or [can-define/map/map] properties into streams.\n\n  ```js\n  var canStream = require(\"can-stream-kefir\");\n  var DefineMap = require(\"can-define/map/map\");\n\n  var me = new DefineMap({name: \"Justin\"});\n\n  var nameStream = canStream.toStream(me,\".name\");\n\n\n  nameStream.onValue(function(name){\n\t  // name -> \"Obaid\";\n  });\n\n  me.name = \"Obaid\";\n  ```\n"}],"name":"can-stream-kefir","parent":"can-ecosystem","package":{"author":{"email":"contact@bitovi.com","name":"Bitovi","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-stream-kefir/issues"},"dependencies":{"can-compute":"^3.1.0","can-event":"^3.5.0","can-observation":"^3.2.0","can-stream":"^0.3.0","can-util":"^3.9.0","kefir":"^3.5.1"},"description":"Stream values into and out of computes","devDependencies":{"can-define":"^1.2.3","done-serve":"^1.3.0","donejs-cli":"^1.0.1","generator-donejs":"^1.0.5","jshint":"^2.9.1","steal":"^1.5.4","steal-qunit":"^1.0.1","steal-tools":"^1.3.6","testee":"^0.6.1"},"directories":{},"dist":{"integrity":"sha512-gdrrknvu7ltID6rFQIoiJMK+zzcvtfp5TiUCDNnI1loQC+u3rRpBlo+Nts/omzzu9xpWvI4qhQgClf+xHrZx9w==","shasum":"e4af7fd29cc51a1aac595cc178b82c9b719bc475","tarball":"https://registry.npmjs.org/can-stream-kefir/-/can-stream-kefir-0.3.1.tgz"},"gitHead":"81d498153b309da04f756a1c0e1d6e4b7fc66717","homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs"],"main":"can-stream-kefir","maintainers":[{"email":"chasen@chasenlehara.com","name":"chasen"},{"email":"justin@bitovi.com","name":"justinbmeyer"},{"email":"marshall@creativeideal.net","name":"marshallswain"},{"email":"obaid@bitovi.com","name":"obaidott"},{"email":"kphillips86@gmail.com","name":"phillipskevin"},{"email":"john@ardea.io","name":"sinjhin"}],"name":"can-stream-kefir","optionalDependencies":{},"repository":{"type":"git","url":"git://github.com/canjs/can-stream-kefir.git"},"scripts":{"build":"node build.js","develop":"done-serve --static --develop --port 8080","jshint":"jshint *.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag pre","test":"npm run jshint && npm run testee","testee":"testee test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"configDependencies":["live-reload"]},"version":"0.3.1"},"comment":" ","pathToRoot":".."};
</script>
</article>
