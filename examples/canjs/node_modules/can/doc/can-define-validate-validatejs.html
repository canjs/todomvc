...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define-validate-validatejs/docs/can-define-validate-validatejs.md"},"description":"Adds validation methods and observables to a [can-define/map/map] using [validate.js](https://validatejs.org/).\n\n","type":"module","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-define-validate-validatejs","parent":"can-ecosystem","package":{"author":{"name":"Bitovi"},"browser":{},"bugs":{"url":"https://github.com/canjs/can-define-validate-validatejs/issues"},"dependencies":{"can-define":"^1.2.0","can-util":"^3.9.0","can-validate":"^1.1.0","can-validate-validatejs":"0.1.0"},"description":"Validation helpers for can-define maps and lists.","devDependencies":{"bit-docs":"^0.0.7","can-compute":"^3.1.0","http-server":"^0.9.0","jshint":"^2.9.4","steal":"^1.0.8","steal-qunit":"^1.0.0","steal-tools":"^1.0.1","testee":"^0.3.0"},"directories":{},"dist":{"integrity":"sha512-cd5fEEkr88k9NIT6K6gokRVzO0sjEEPOirC9GaMnoA0ArP+Wlz8lzpegtFBQSjc7jFtkzQjNyt/hVlm+mbM8GA==","shasum":"1396dc2ede0a08c4e870721e2df653f1fe95f82f","tarball":"https://registry.npmjs.org/can-define-validate-validatejs/-/can-define-validate-validatejs-0.1.1.tgz"},"gitHead":"7301cb070c1702896e51a5494eccf33d513ca1d1","homepage":"https://github.com/canjs/can-define-validate-validatejs","keywords":["Validate","plugin","canjs"],"license":"MIT","main":"can-define-validate-validatejs.js","maintainers":[{"email":"hi@juanorozco.com","name":"macrofig"},{"email":"kphillips86@gmail.com","name":"phillipskevin"}],"name":"can-define-validate-validatejs","optionalDependencies":{},"repository":{"type":"git","url":"git+https://github.com/canjs/can-define-validate-validatejs.git"},"scripts":{"build":"node build.js","develop":"http-server -c-1","document":"bit-docs","jshint":"jshint *.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm run build && npm publish","release:minor":"npm version minor && npm run build && npm publish","release:patch":"npm version patch && npm run build && npm publish","release:pre":"npm version prerelease && npm run build && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"ignoreBrowser":true,"npmAlgorithm":"flat","npmDependencies":["steal-qunit"],"npmIgnore":["documentjs","testee","steal-tools"],"transpiler":"babel"},"version":"0.1.1"},"signatures":[{"code":"defineValidate(Map)","description":"\n\n  Checks for ValidateJS constraints and attaches useful methods.\n\n  ```js\n  var defineValidate = require('can-define-validate-validatejs');\n  var User = DefineMap.extend({\n      name: {\n          validate: {\n              presence: true\n          }\n      }\n  });\n  // Attach methods to any instance created of `User`\n  defineValidate(User);\n  var user = new User();\n  user.errors();//-> [{name: ['is required']}]\n  ```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"Map","description":"The [can-define/map/map] constructor. Adds [can-define-validate-validatejs.errors] and [can-define-validate-validatejs.test-set] methods to the prototype of this map.\n"}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"Map","description":"The [can-define/map/map] constructor. Adds [can-define-validate-validatejs.errors] and [can-define-validate-validatejs.test-set] methods to the prototype of this map.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
