...
If the dependencies include properties on a Map-like object, they are placed in a <a href="../../can-util/js/cid-map/cid-map.html" title="Exports the native Map
or a polyfill.">CIDMap</a>
...
placed in a <a href="../../can-util/js/cid-set/cid-set.html" title="Exports the native Set
or a polyfill.">CIDSet</a> keyed on <code>valueDependencies</code>.
