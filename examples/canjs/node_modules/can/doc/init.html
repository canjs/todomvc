	...
	<div class="page-type">
		<h1>init</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/ref/ref.js#L380">Edit on GitHub</a>
				</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"init","params":[],"parent":"can-connect/can/ref/ref.methods","src":{"line":379,"codeLine":385,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"\n","desc":["Initializes the SignalR Hub Proxy","and sets up the RPC listeners for the standard"],"can":"-connect/can/ref/ref.init init","comment":"Initializes the base connection and then creates and sets [can-connect/can/ref/ref.Map.Ref]. ","pathToRoot":".."};
</script>
</article>
