...
<p>Handles encoding of certain characthers:</p>
<ol>
<li>Spaces (<code></code>) - Encoded to <code>\s</code>.</li>
<li>Forward Slashes (<code>/</code>) - Encoded to <code>\f</code>.</li>
</ol>
