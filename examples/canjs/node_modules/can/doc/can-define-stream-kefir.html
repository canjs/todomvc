...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-define-stream-kefir/docs/can-define-stream-kefir.md"},"description":"Export a function that takes a [can-define/map/map] or [can-define/list/list] constructor and uses [can-stream-kefir] to create streamable properties. \n","type":"module","title":"can-define-stream-kefir","types":[{"type":"Object","options":[]}],"name":"can-define-stream-kefir","parent":"can-ecosystem","package":{"author":{"email":"contact@bitovi.com","name":"Bitovi","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-define-stream-kefir/issues"},"dependencies":{"can-compute":"^3.1.0-pre.9","can-define":"^1.2.0-pre.4","can-define-stream":"^0.2.0-pre.0","can-observation":"^3.2.0-pre.11","can-stream-kefir":"^0.3.0-pre.0","can-util":"^3.9.0-pre.4","kefir":"^3.5.1"},"description":"Adds the ability to define properties with streams on can-define types.","devDependencies":{"done-serve":"^0.2.4","donejs-cli":"^0.9.5","generator-donejs":"^0.9.0","jshint":"^2.9.1","steal":"^1.0.6","steal-qunit":"^1.0.0","steal-tools":"^1.0.1","testee":"^0.3.0"},"directories":{},"dist":{"integrity":"sha512-B0g+VR3wGCLMA2b/sagnwJFjE9IDvYLkwjFfyggHLZwEgARNYYwL04A2QW0dXltMgjTym52/wrIVR2zKM+mKcw==","shasum":"d1e4bec6e0baaa98c56db3ace0473beec5afff79","tarball":"https://registry.npmjs.org/can-define-stream-kefir/-/can-define-stream-kefir-0.1.0.tgz"},"gitHead":"04b444d0df438fadb98e407c115babbe6d277d87","homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs"],"main":"can-define-stream-kefir","maintainers":[{"email":"justin@bitovi.com","name":"justinbmeyer"},{"email":"obaid@bitovi.com","name":"obaidott"},{"email":"kphillips86@gmail.com","name":"phillipskevin"},{"email":"john@ardea.io","name":"sinjhin"}],"name":"can-define-stream-kefir","optionalDependencies":{},"repository":{"type":"git","url":"git://github.com/canjs/can-define-stream-kefir.git"},"scripts":{"develop":"done-serve --static --develop --port 8080","jshint":"jshint *.js --config","postversion":"git push --tags && git push","preversion":"npm test","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag pre","test":"npm run jshint && npm run testee","testee":"testee test.html --browsers firefox"},"system":{"configDependencies":["live-reload"],"npmAlgorithm":"flat"},"version":"0.1.0"},"signatures":[{"code":"canDefineStreamKefir(DefineMap)","description":"\n\nThe `can-define-stream-kefir` module exports a function that will take a [can-define-stream-kefir.types.DefineMap DefineMap] or [can-define-stream-kefir.types.DefineList DefineList] constructor and add the following methods using the [can-stream-kefir] stream implementation:\n\n- .toStream(observable, propAndOrEvent[,event])\n- .toStreamFromProperty(property)\n- .toStreamFromEvent(property)\n- .toCompute([can-stream.types.makeStream makeStream(setStream)], context):compute\n\n```js\nvar canDefineStreamKefir = require(\"can-define-stream-kefir\");\nvar DefineMap = require(\"can-define/map/map\");\n\nvar Person = DefineMap.extend({\n    first: \"string\",\n    last: \"string\",\n    fullName: {\n        get: function() {\n            return this.first + \" \" + this.last;\n        }\n    },\n    fullNameChangeCount: {\n        stream: function() {\n            return this.toStream(\".fullName\").scan(function(last) {\n                return last + 1;\n            }, 0);\n        }\n    }\n});\n\ncanDefineStreamKefir(Person);\n\nvar me = new Person({name: \"Justin\", last: \"Meyer\"});\n\nme.on(\"fullNameChangeCount\", function(ev, newVal) {\n    console.log(newVal);\n});\n\nme.fullNameChangeCount //-> 0\n\nme.first = \"Obaid\"; //-> console.logs 1\nme.last = \"Ahmed\"; //-> console.logs 2\n\n```\n","params":[]}],"comment":" ","pathToRoot":".."};
</script>
</article>
