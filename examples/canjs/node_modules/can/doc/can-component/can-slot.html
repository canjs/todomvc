...
<p><a href="../can-stache-bindings.toChild.html" title="One-way bind a value in the parent scope to the ViewModel.">{to-child}</a>, <a href="../can-stache-bindings.toParent.html" title="One-way bind a value in the current viewModel to the parent scope.">{^to-parent}</a> and <a href="../can-stache-bindings.twoWay.html" title="Two-way bind a value in the viewModel or the element to the parent scope.">{(two-way)}</a> with <code>this</code>
all work.</p>
</li>
