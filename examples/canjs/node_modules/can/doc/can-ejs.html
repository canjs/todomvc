...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-ejs/doc/can-ejs.md"},"description":"EJS provides __live__ ERB-style client-side templates. \n","type":"module","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-ejs","parent":"can-legacy","package":{"author":{"email":"justin@bitovi.com","name":"Bitovi","url":"http://bitovi.com"},"dependencies":{"can-compute":"^3.3.0","can-legacy-view-helpers":"^0.6.0-pre.0","can-namespace":"^1.0.0","can-observation":"^3.3.0","can-reflect":"^1.1.0","can-stache-key":"0.0.3","can-util":"^3.9.0-pre.4"},"description":"legacy EJS layer for canjs","devDependencies":{"can-list":"^3.1.0-pre.9","can-map":"^3.1.0-pre.10","documentjs":"^0.4.2","jshint":"^2.9.1","steal":"^1.2.8","steal-qunit":"^1.0.1","steal-tools":"^1.1.2","testee":"^0.3.1"},"directories":{},"dist":{"shasum":"fbbda18525cda399edbeec28db943831b6fc6965","tarball":"https://registry.npmjs.org/can-ejs/-/can-ejs-3.1.2.tgz"},"gitHead":"c2341b5f6ab5d1064b53bba6ca02309aadeb7455","homepage":"https://canjs.com/2.3/docs/can.ejs.html","keywords":["CanJS","MVVM"],"main":"can-ejs","maintainers":[{"email":"brad@bitovi.com","name":"bmomberger-bitovi"},{"email":"daff@neyeon.de","name":"daffl"},{"email":"ryan.wheale@gmail.com","name":"designbyonyx"},{"email":"justin@bitovi.com","name":"justinbmeyer"},{"email":"marshall@creativeideal.net","name":"marshallswain"},{"email":"kphillips86@gmail.com","name":"phillipskevin"}],"name":"can-ejs","optionalDependencies":{},"scripts":{"build":"node build.js","develop":"can-serve --static --develop --port 8080","document":"documentjs","jshint":"jshint can-ejs.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version pre && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"configDependencies":["live-reload"],"ext":{"ejs":"src/system"},"main":"can-ejs","npmIgnore":["documentjs","testee","generator-donejs","donejs-cli","steal-tools"]},"version":"3.1.2"},"deprecated":[{"version":"2.1","description":"EJS is incompatible with [can-component] and should\nbe avoided for new projects. Projects using EJS should consider\nswitching to [can-stache].\n"}],"signatures":[{"code":"ejs( template )","description":"\n\nReturns `template` compiled to a renderer function.\n\n```js\nvar ejs = require(\"can-ejs\");\nvar renderer = ejs(\"<h1><%= message %></h1>\");\nvar frag = renderer({message: \"Hello World\"});\nfrag //-> <h1>Hello World</h1>\n\ndocument.body.appendChild(frag);\n```\n","params":[{"types":[{"type":"String"}],"name":"template","description":"The content of the mustache template.\n"}],"returns":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Any"}]}]}],"description":"A function that renders the ejs template into\na live documentFragment given data.\n"}},{"code":"new ejs(options)","description":"\n\nCreates an EmbeddedJS template instance.  This form can be used\nto render a string.\n\n```js\nvar ejs = require(\"can-ejs\");\nvar ejsInstance = new ejs({\n\ttext: \"<h1><%= message %></h1>\"\n});\nvar string = ejsInstance.render({message: \"Hello World\"});\nstring //-> \"<h1>Hello World</h1>\"\n```\n","params":[]}],"_curReturn":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"Any"}]}]}],"description":"A function that renders the ejs template into\na live documentFragment given data.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
