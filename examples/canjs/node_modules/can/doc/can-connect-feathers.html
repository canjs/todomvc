			...
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-connect-feathers">
						<img src="https://img.shields.io/badge/npm%20package-3.6.0-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-feathers/_docs/can-connect-feathers.md"},"description":"Integrate can-connect with the FeathersJS Client \n","type":"module","title":"","types":[{"type":"Object","options":[],"description":"\n\n`can-connect-feathers` is a set of behaviors for integrating [can-connect] with [Feathers Client](https://docs.feathersjs.com/clients/feathers.html).\n\n - The [can-connect-feathers/service/service service] behavior connects to a Feathers service.\n - The [can-connect-feathers/session/session session] behavior connects to the [feathers-authentication-client](https://docs.feathersjs.com/authentication/client.html) methods on a Feathers Client instance.\n"}],"name":"can-connect-feathers","parent":"can-ecosystem","package":{"author":{"email":"marshall@creativeideal.net","name":"Marshall Thompson","url":"https://github.com/icanjs"},"bugs":{"url":"https://github.com/canjs/can-connect-feathers/issues"},"dependencies":{"can-observation":"^3.2.0-pre.11","can-util":"^3.9.0-pre.4","can-zone-storage":"^1.0.0","feathers-authentication-popups":"^0.1.2","feathers-errors":"^2.7.0","jwt-decode":"^2.1.0"},"description":"Feathers client library for DoneJS and can-connect","devDependencies":{"async":"^2.1.5","babel-polyfill":"^6.23.0","can-connect":"^1.5.0-pre.0","can-define":"^1.2.0-pre.4","can-fixture":"^1.1.0-pre.2","can-fixture-socket":"^0.7.0-pre.1","can-set":"^1.3.0-pre.0","can-zone":"^0.6.1","concurrently":"^3.1.0","documentjs":"^0.4.4","done-serve":"^0.2.5","donejs-cli":"^0.9.5","feathers":"^2.0.3","feathers-authentication-client":"^0.3.2","feathers-hooks":"^1.7.1","feathers-rest":"^1.5.0","feathers-socketio":"^1.4.2","generator-donejs":"^0.9.0","http-server":"^0.9.0","jquery":"^3.1.0","jshint":"^2.9.4","saucelabs":"^1.4.0","socket.io-client":"^1.7.2","steal":"^1.0.5","steal-qunit":"^1.0.0","steal-socket.io":"^4.0.8","steal-tools":"^1.0.1","test-saucelabs":"0.0.1","testee":"^0.3.0","wd":"^1.1.3"},"directories":{},"dist":{"integrity":"sha512-IgALuG8IDWKI8ghz30iz4oQD4+giAYmhhbxn3aAJW0t9ncf+RL7b7acHMM84PTENeVJ+LJYU8GcC2aiHEjM99Q==","shasum":"c0c45a565974de21e3ecbc7920d92ee99623c263","tarball":"https://registry.npmjs.org/can-connect-feathers/-/can-connect-feathers-3.6.0.tgz"},"gitHead":"a3c3a43a05de445a78ea842529e36496bbcde816","homepage":"https://github.com/canjs/can-connect-feathers","keywords":["canjs","can","plugin","donejs","feathersjs","feathers","client","realtime"],"main":"can-connect-feathers","maintainers":[{"email":"daff@neyeon.de","name":"daffl"},{"email":"fadeev.ilya@gmail.com","name":"ilyavf"},{"email":"justin@bitovi.com","name":"justinbmeyer"},{"email":"marshall@creativeideal.net","name":"marshallswain"},{"email":"kphillips86@gmail.com","name":"phillipskevin"}],"name":"can-connect-feathers","optionalDependencies":{},"repository":{"type":"git","url":"git://github.com/canjs/can-connect-feathers.git"},"scripts":{"build":"node build.js","ci":"node test/test-sauce-labs.js","develop":"done-serve --static --develop --port 8080","document":"documentjs","http-server":"http-server -p 3000 --silent","install-server-deps":". ./build-server.sh","jshint":"jshint --config .jshintrc --exclude node_modules/,dist/,.vscode/,_docs/,test/server/ .","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:prerelease":"npm version prerelease && npm publish --tag pre","start":"node ./test/server/src/index.js","start-test":"node ./test/server/src/index.js --timeout","test":"npm run jshint && npm run testee","test-integration":"npm run jshint && npm run install-server-deps && concurrently 'npm run start-test' 'npm run testee-integration' ","testee":"testee test/test.html --browsers firefox","testee-integration":"testee test/test-integration.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"configDependencies":["live-reload"],"npmIgnore":["documentjs","testee","generator-donejs","donejs-cli","steal-tools"]},"version":"3.6.0"},"comment":" ","pathToRoot":".."};
</script>
</article>
