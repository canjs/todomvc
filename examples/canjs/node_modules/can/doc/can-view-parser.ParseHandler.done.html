...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-parser/docs/done.md"},"description":"","title":"done","name":"can-view-parser.ParseHandler.done","type":"function","parent":"can-view-parser.ParseHandler","signatures":[{"code":"done()","description":"\n\nCalled at the end of parsing the template.\n","params":[]}],"pathToRoot":".."};
</script>
</article>
