			...
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-set">
						<img src="https://img.shields.io/badge/npm%20package-1.3.0-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-set/docs/can-set.md"},"description":" \ncan-set is a utility for comparing [can-set/Set sets] that are represented by the parameters commonly passed to service requests.\n\n","type":"module","title":"","types":[{"type":"Object","options":[],"description":"\n\nOnce you've imported the `can-set` module into your project, use it to create a `set.Algebra` and then use that to compare and perform operations on sets.  \n\n```js\nvar set = require('can-set');\n// create an algebra\nvar algebra = new set.Algebra(\n    // specify the unique identifier on data\n    set.props.id(\"_id\"),  \n    // specify that completed can be true, false or undefined\n    set.props.boolean(\"completed\"),\n    // specify properties that define pagination\n    set.props.rangeInclusive(\"start\",\"end\"),\n    // specify the property that controls sorting\n    set.props.sort(\"orderBy\"),\n)\n\n// compare two sets\nalgebra.subset({start: 2, end: 3}, {start: 1, end: 4}) //-> true\nalgebra.difference({} , {completed: true}) //-> {completed: false}\n\n// perform operations on sets\nalgebra.getSubset({start: 2,end: 3},{start: 1,end: 4},\n            [{id: 1},{id: 2},{id: 3},{id: 4}])\n//-> [{id: 2},{id: 3}]\n```\n"}],"name":"can-set","parent":"can-core","package":{"author":{"name":"Bitovi"},"bit-docs":{"dependencies":{"bit-docs-dev":"^0.0.3","bit-docs-generate-readme":"^0.0.10","bit-docs-glob-finder":"^0.0.5","bit-docs-js":"^0.0.4"},"glob":{"ignore":"node_modules/**/*","pattern":"**/*.{js,md}"},"parent":"can-set","readme":{"apis":"./docs/apis.json"}},"bugs":{"url":"https://github.com/canjs/can-set/issues"},"dependencies":{"can-namespace":"^1.0.0","can-util":"^3.9.0-pre.4"},"description":"Set logic for CanJS","devDependencies":{"bit-docs":"^0.0.7","jshint":"^2.7.0","steal":"^1.0.1","steal-qunit":"^1.0.0","steal-tools":"^1.0.0","testee":"^0.3.0"},"directories":{},"dist":{"integrity":"sha512-3zEG0TSyCMdhhqmaUTHq6C+b7Y71FXbEGS8/6Afa4/YcY9fsD+Z4LQszOo6dQYYVng4M8hCelWmi5e0N2TESeQ==","shasum":"cc647d867c2b676e2346f2da9ac8cce69e5428d2","tarball":"https://registry.npmjs.org/can-set/-/can-set-1.3.0.tgz"},"gitHead":"1da71d8c0cbc2a519cb836961da6eaeb824a2025","homepage":"https://github.com/canjs/can-set","keywords":["canjs"],"license":"MIT","main":"src/set.js","maintainers":[{"email":"daff@neyeon.de","name":"daffl"},{"email":"garrett@garrettreed.co","name":"garrettreed"},{"email":"justin@bitovi.com","name":"justinbmeyer"},{"email":"matthew@matthewphillips.info","name":"matthewp"},{"email":"nlundqu@gmail.com","name":"nlundquist"},{"email":"kphillips86@gmail.com","name":"phillipskevin"},{"email":"john@ardea.io","name":"sinjhin"}],"name":"can-set","optionalDependencies":{},"repository":{"type":"git","url":"git+https://github.com/canjs/can-set.git"},"scripts":{"build":"node build.js","jshint":"jshint src/. --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"plugins":["steal-qunit"]},"version":"1.3.0"},"comment":" ","pathToRoot":".."};
</script>
</article>
