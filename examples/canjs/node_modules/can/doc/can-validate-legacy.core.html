...
<script type="text/javascript">
  window.docObject = {"name":"can-validate-legacy.core","title":"Core","type":"function","parent":"can-validate-legacy","description":"  Returns an object with helpful methods that will call a validation library to validate\n values.\n\n How each method behaves depends on the chosen shim and validation library.\n\n","order":1,"src":{"path":"node_modules/can-validate-legacy/docs/can-validate-legacy-core.md"},"comment":" ","signatures":[{"code":"validate.register(LIBRARY_NAME, MAP_OF_METHODS)","description":"\n\nThe `MAP_OF_METHODS` consists of three methods that define the three main uses cases, validate many, validate one, and check one.\n\n## Demo\n","params":[]}],"pathToRoot":".."};
</script>
</article>
