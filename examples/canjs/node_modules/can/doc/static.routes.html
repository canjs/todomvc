	...
	<div class="page-type">
		<h1>static.routes</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-route/edit/master/can-route.js#L558">Edit on GitHub</a>
				</li>
...
<script type="text/javascript">
  window.docObject = {"name":"static.routes","type":"property","parent":"static","src":{"line":557,"codeLine":576,"path":"node_modules/can-route/can-route.js"},"description":"\nA list of routes recognized by the router indixed by the url used to add it.\nEach route is an object with these members:\n","types":[{"type":"Object","options":[]}],"title":"","hide":true,"pathToRoot":".."};
</script>
</article>
