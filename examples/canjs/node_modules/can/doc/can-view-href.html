...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-view-href/can-view-href.md"},"description":"Sets an element’s `href` attribute so that its url will set the specified attribute values on [can-route]. \n","type":"module","title":"","types":[{"type":"undefined"}],"name":"can-view-href","parent":"can-legacy","package":{"author":{"email":"contact@bitovi.com","name":"Bitovi","url":"http://bitovi.com"},"dependencies":{"can-compute":"^3.1.0-pre.9","can-route":"^3.1.0-pre.2","can-stache":"^3.1.0-pre.4","can-util":"^3.9.0-pre.4","can-view-callbacks":"^3.1.0-pre.0","can-view-scope":"^3.2.0-pre.10"},"description":"Make flexible route links","devDependencies":{"can-map":"^3.1.0-pre.10","can-ssr":"^0.11.6","donejs-cli":"^0.9.5","generator-donejs":"^0.9.6","jshint":"^2.9.1","steal":"^1.2.10","steal-qunit":"^1.0.1","steal-tools":"^1.1.2","testee":"^0.3.1"},"directories":{},"dist":{"integrity":"sha512-SZvOPcbbOsVc/QhkXs3pf4Kl7q4dbvstKHyBKJUOLB3HufAb64D9z526q+yVGaVjcmIkBfVCUBx5d/1ybqxRcw==","shasum":"198e7fd12cbaad9c98392235e22041da7afa2ff3","tarball":"https://registry.npmjs.org/can-view-href/-/can-view-href-3.1.0.tgz"},"gitHead":"c56451a3395b9aa03ea072ee6451acef95e5f553","homepage":"https://canjs.com","keywords":["canjs","donejs","canjs-plugin"],"main":"can-view-href","maintainers":[{"email":"daff@neyeon.de","name":"daffl"},{"email":"justin@bitovi.com","name":"justinbmeyer"},{"email":"marshall@creativeideal.net","name":"marshallswain"},{"email":"matthew@matthewphillips.info","name":"matthewp"},{"email":"kphillips86@gmail.com","name":"phillipskevin"}],"name":"can-view-href","optionalDependencies":{},"scripts":{"build":"node build.js","develop":"can-serve --static --develop --port 8080","jshint":"jshint *.js test/*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"configDependencies":["live-reload"],"main":"can-view-href","npmIgnore":["testee","generator-donejs","donejs-cli","steal-tools"]},"version":"3.1.0"},"deprecated":[{"version":"2.3","description":"Use the [can-stache.helpers.routeUrl routeUrl helper] instead like:\n`href=\"{{routeUrl prop=value}}\"`.\n"}],"signatures":[{"code":"can-href='{[attrName=attrValue...]}'","description":"\n","params":[{"types":[{"type":"String"}],"name":"attrName","description":""},{"types":[{"type":"can-stache/expressions/key-lookup"}],"name":"attrValue","description":"\n"}]}],"_curParam":{"types":[{"type":"can-stache/expressions/key-lookup"}],"name":"attrValue","description":"\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
