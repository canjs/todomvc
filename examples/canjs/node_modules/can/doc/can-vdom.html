...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-vdom/can-vdom.md"},"description":"A browser-lite environment for Node.js or a worker thread. \n","type":"module","title":"","types":[{"type":"undefined","description":"\n\nThe `can-vdom` module does not export anything, but it changes the current\nenvironment to have the limited subset of browser environment behavior and\nfunctionality needed to support CanJS templates and other behavior without\na native DOM.\n\n```js\nrequire(\"can-vdom\");\n\nwindow === global; // true\n\ndocument.getElementsByTagName(\"body\"); // [HTMLBodyElement]\n```\n\n`can-vdom` decorates the environment `global` to include:\n\n - a non-functional `navigator`, `location`, and `history` object.\n - a limitedly functional `document` with basic `Node` behavior, event binding and dispatching.\n\n\n"}],"name":"can-vdom","parent":"can-ecosystem","package":{"author":{"email":"contact@bitovi.com","name":"Bitovi","url":"http://bitovi.com"},"bit-docs":{"dependencies":{"bit-docs-dev":"^0.0.3","bit-docs-generate-readme":"^0.0.8","bit-docs-glob-finder":"^0.0.5","bit-docs-js":"^0.0.3"},"glob":{"ignore":"node_modules/**/*","pattern":"**/*.{js,md}"},"parent":"can-vdom","readme":{"apis":"./docs/apis.json"}},"bugs":{"url":"https://github.com/canjs/can-vdom/issues"},"dependencies":{"can-simple-dom":"^1.0.0","can-util":"^3.9.0-pre.4","can-view-parser":"^3.4.0-pre.0"},"description":"A browser-lite environment for nodejs","devDependencies":{"bit-docs":"0.0.7","chai":"^3.4.1","done-serve":"^0.2.0","donejs-cli":"^0.9.4","generator-donejs":"^0.9.0","jshint":"^2.9.1","mocha":"^2.3.4","steal":"^1.2.10","steal-mocha":"^1.0.0","steal-tools":"^1.1.2","testee":"^0.3.1"},"directories":{},"dist":{"integrity":"sha512-lu1yLtLMocz5i9uJ0oxP4Ns78dJDKTlyotJMC9bgr+U2+vDh1VDtdJsBkLaUW/hS+AhAQinxY5OE5ClvMjVyJg==","shasum":"959c64b3abe6f81e5928943b7658b655a251ce91","tarball":"https://registry.npmjs.org/can-vdom/-/can-vdom-3.1.0.tgz"},"gitHead":"b1b277e5e8c64cee8cd74a2862df3985867e078b","homepage":"http://canjs.com","keywords":["donejs","canjs"],"main":"can-vdom.js","maintainers":[{"email":"daff@neyeon.de","name":"daffl"},{"email":"justin@bitovi.com","name":"justinbmeyer"},{"email":"marshall@creativeideal.net","name":"marshallswain"},{"email":"matthew@matthewphillips.info","name":"matthewp"},{"email":"kphillips86@gmail.com","name":"phillipskevin"},{"email":"john@ardea.io","name":"sinjhin"}],"name":"can-vdom","optionalDependencies":{},"repository":{"type":"git","url":"git://github.com/canjs/can-vdom.git"},"scripts":{"build":"node build.js","develop":"done-serve --static --develop --port 8080","document":"bit-docs","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run test:node && npm run test:browser","test:browser":"testee test/test.html --browsers firefox --reporter Spec","test:node":"mocha test/test.js","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"main":"can-vdom","map":{"./assert":"chai/chai"},"meta":{"chai/chai":{"exports":"chai.assert","format":"global"}},"plugins":["chai"]},"version":"3.1.0"},"comment":" ","pathToRoot":".."};
</script>
</article>
