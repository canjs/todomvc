	...
	<div class="page-type">
		<h1>static</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-define/edit/master/list/list.js#L41">Edit on GitHub</a>
				</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":40,"codeLine":41,"path":"node_modules/can-define/list/list.js"},"type":"static","description":"","name":"can-define/list/list.static","parent":"can-define/list/list","title":"static","pathToRoot":"../../.."};
</script>
</article>
