...
<div class="signature">
  ...
  <p>The <code>data</code> property of <code>can-zone-storage</code> is a plain old JavaScript object.  It is used as the memory-based storage when window.CanZone is undefined (when the <a href="can-zone.html" title="">can-zone</a> module hasn't been loaded).  If <code>window.CanZone</code> is found (when <a href="can-zone.html" title="">can-zone</a> is used), the <code>CanZone.current.data</code> object is used, instead, for Zone-safe storage.</p>
