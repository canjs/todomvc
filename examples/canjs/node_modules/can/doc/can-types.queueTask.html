	...
	<div class="page-type">
		<h1>queueTask</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-types/edit/master/can-types.js#L92">Edit on GitHub</a>
				</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-types.queueTask","parent":"can-types","src":{"line":91,"codeLine":97,"path":"node_modules/can-types/can-types.js"},"description":"","title":"queueTask","signatures":[{"code":"types.queueTask(task)","description":"\n  Run code that will be queued at the end of the current batch.","params":[{"types":[{"type":"Array","options":[]}],"name":"task","description":"\n "}]}],"_curParam":{"types":[{"type":"Array","options":[]}],"name":"task","description":"\n "},"pathToRoot":".."};
</script>
</article>
