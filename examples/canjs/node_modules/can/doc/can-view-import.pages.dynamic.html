...
<section class="on-this-page-table">
    ...
    <section class="body">
    <p>To make your import be loaded dynamically it <em>cannot</em> be self closing (i.e. <code>/&gt;</code>) but rather it must have a closing tag (i.e. <code>&lt;/can-import&gt;</code>).</p>
<h3>Example</h3>
<p>These <code>can-import</code> and Steal import examples are equivalent:</p>
