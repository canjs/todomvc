			...
			<ul class="title-social">
				...
				<li>
					<a class="npm-button" href="https://www.npmjs.com/package/can-connect-signalr">
						<img src="https://img.shields.io/badge/npm%20package-0.2.0-brightgreen.svg" alt="npm package badge" />
					</a>
				</li>
				<li>
...
<p>and calling: <a href="can-connect/real-time/real-time.createInstance.html" title="Programatically indicate a new instance has been created.">createInstance</a>, <a href="can-connect/real-time/real-time.updateInstance.html" title="Programatically indicate a new instance has been updated.">updateInstance</a>, or <a href="can-connect/real-time/real-time.destroyInstance.html" title="Programatically indicate a new instance has been destroyed.">destroyInstance</a>.</p></li>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>can-connect-signalr</code> is a <a href="can-connect.html" title="can-connect provides persisted data middleware. Use it to assemble powerful model layers for any JavaScript project.">can-connect</a> behavior that makes a connection that can communicate with a
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect-signalr/docs/can-connect-signalr.md"},"description":"Connect to a [Hub](https://docs.microsoft.com/en-us/aspnet/signalr/overview/guide-to-the-api/hubs-api-guide-server) on a\n[SignalR](https://docs.microsoft.com/en-us/aspnet/signalr/) server.\n\n","type":"module","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-connect-signalr","parent":"can-ecosystem","package":{"author":{"email":"contact@bitovi.com","name":"Bitovi","url":"http://bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-connect-signalr/issues"},"dependencies":{"can-connect":"^1.5.0-pre.0","jquery":"2.x - 3.x","ms-signalr-client":"^2.2.5"},"description":"can-connect-signalr is a set of behaviors for integrating can-connect with Microsoft's signalR","devDependencies":{"can-define":"^1.2.0-pre.4","jshint":"^2.9.1","steal":"^1.5.2","steal-qunit":"^1.0.1","steal-tools":"^1.0.0","testee":"^0.5.0"},"directories":{},"dist":{"integrity":"sha512-iDNe4PXZaqnvpNIr6AVEk2fQV9MsciAKoY/BA66sLc28j6kXza4jvEO6rqdbL2/gJLZnaruqLw0tm3g5cMspHA==","shasum":"4f61bae62514e1f3745001dc2e472258da5eb872","tarball":"https://registry.npmjs.org/can-connect-signalr/-/can-connect-signalr-0.2.0.tgz"},"gitHead":"52d1a69e01e544bf21ec94e8c2b0b88afc474544","homepage":"https://github.com/canjs/can-connect-signalr#readme","keywords":[],"license":"MIT","main":"can-connect-signalr","maintainers":[{"email":"justin@bitovi.com","name":"justinbmeyer"},{"email":"matthew@matthewphillips.info","name":"matthewp"},{"email":"kphillips86@gmail.com","name":"phillipskevin"}],"name":"can-connect-signalr","optionalDependencies":{},"repository":{"type":"git","url":"git+https://github.com/canjs/can-connect-signalr.git"},"scripts":{"develop":"done-serve --static --develop --port 8080","document":"bit-docs","jshint":"jshint ./*.js --config","preversion":"npm test","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test.html --browsers firefox"},"system":{"transpiler":"babel"},"version":"0.2.0"},"signatures":[{"code":"connectSignalR( baseBehavior )","description":"\n\nEncapsulates connecting to a `SignalR` hub, by:\n\n- implementing the: [can-connect-signalr/createData],  [can-connect-signalr/updateData], [can-connect-signalr/getData], [can-connect-signalr/getListData], and [can-connect-signalr/destroyData] [can-connect/DataInterface] methods to make RPC calls to the server.\n- listening for the following messages pushed from the server to the browser:\n  - [can-connect-signalr.signalR]`.createdName`,\n  - [can-connect-signalr.signalR]`.updatedName`,\n  - [can-connect-signalr.signalR]`.destroyedName`\n\n  and calling: [can-connect/real-time/real-time.createInstance], [can-connect/real-time/real-time.updateInstance], or [can-connect/real-time/real-time.destroyInstance].\n","params":[]}],"comment":" ","pathToRoot":".."};
</script>
</article>
