	...
	<div class="page-type">
		<h1>serialize</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/ref/ref.js#L344">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Returns the <code>idProp</code>.</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/ref/ref.Map.Ref.prototype.serialize","parent":"can-connect/can/ref/ref.Map.Ref.prototype","src":{"line":343,"codeLine":350,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"","title":"serialize","signatures":[{"code":"ref.serialize","description":"\nReturns the `idProp`.","params":[],"returns":{"types":[{"type":"string"}],"description":"idProp\n "}}],"_curReturn":{"types":[{"type":"string"}],"description":"idProp\n "},"pathToRoot":"../../../.."};
</script>
</article>
