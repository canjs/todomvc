	...
	<div class="page-type">
		<h1>store</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/ref/ref.js#L203">Edit on GitHub</a>
				</li>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/can/ref/ref.Map.Ref.store","type":"property","parent":"can-connect/can/ref/ref.Map.Ref.static","src":{"line":202,"codeLine":207,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"A WeakReferenceMap that contains instances being created by their `._cid` property.\n","types":[{"type":"can-connect/helpers/weak-reference-map"}],"title":"store","pathToRoot":"../../../.."};
</script>
</article>
