	...
	<div class="page-type">
		<h1>reason</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/ref/ref.js#L280">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Handles the rejection case for the promise.</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/can/ref/ref.Map.Ref.prototype.reason","type":"property","parent":"can-connect/can/ref/ref.Map.Ref.prototype","src":{"line":279,"codeLine":286,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"","types":[{"type":"*"}],"title":"reason","signatures":[{"code":"ref.reason","description":"\nHandles the rejection case for the promise.","params":[],"returns":{"types":[{"type":"Object","options":[]}],"description":"error message if the promise is rejected\n\t "}}],"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"error message if the promise is rejected\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
