	...
	<div class="page-type">
		<h1>isRejected</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/ref/ref.js#L322">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Returns boolean if the promise was rejected.</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/ref/ref.Map.Ref.prototype.isRejected","parent":"can-connect/can/ref/ref.Map.Ref.prototype","src":{"line":321,"codeLine":328,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"","title":"isRejected","signatures":[{"code":"ref.isRejected","description":"\nReturns boolean if the promise was rejected.","params":[],"returns":{"types":[{"type":"boolean"}],"description":"\n "}}],"_curReturn":{"types":[{"type":"boolean"}],"description":"\n "},"pathToRoot":"../../../.."};
</script>
</article>
