	...
	<div class="page-type">
		<h1>value</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/ref/ref.js#L262">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Returns the actual object that reference points to.</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/can/ref/ref.Map.Ref.prototype.value","type":"property","parent":"can-connect/can/ref/ref.Map.Ref.prototype","src":{"line":261,"codeLine":268,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"","types":[{"type":"*"}],"title":"value","signatures":[{"code":"ref.value","description":"\nReturns the actual object that reference points to.","params":[],"returns":{"types":[{"type":"object"}],"description":"actual object that reference points to\n\t "}}],"_curReturn":{"types":[{"type":"object"}],"description":"actual object that reference points to\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
