	...
	<div class="page-type">
		<h1>isResolved</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/ref/ref.js#L311">Edit on GitHub</a>
				</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/ref/ref.Map.Ref.prototype.isResolved","parent":"can-connect/can/ref/ref.Map.Ref.prototype","src":{"line":310,"codeLine":318,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"\n","title":"isResolved","signatures":[{"code":"ref.isResolved","description":"\nReturns a {boolean}.","params":[],"returns":{"types":[{"type":"boolean"}],"description":"\n "}}],"_curReturn":{"types":[{"type":"boolean"}],"description":"\n "},"pathToRoot":"../../../.."};
</script>
</article>
