	...
	<div class="page-type">
		<h1>isPending</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/ref/ref.js#L333">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Returns true if the state is not 'resolved' or 'rejected'.</p>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/ref/ref.Map.Ref.prototype.isPending","parent":"can-connect/can/ref/ref.Map.Ref.prototype","src":{"line":332,"codeLine":339,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"","title":"isPending","signatures":[{"code":"ref.isPending","description":"\nReturns true if the state is not 'resolved' or 'rejected'.","params":[],"returns":{"types":[{"type":"boolean"}],"description":"\n "}}],"_curReturn":{"types":[{"type":"boolean"}],"description":"\n "},"pathToRoot":"../../../.."};
</script>
</article>
