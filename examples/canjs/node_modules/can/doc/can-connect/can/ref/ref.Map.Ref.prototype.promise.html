	...
	<div class="page-type">
		<h1>promise</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/ref/ref.js#L231">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Returns a promise if it has already been resolved, if not, returns a new promise.</p>
...
<script type="text/javascript">
  window.docObject = {"name":"can-connect/can/ref/ref.Map.Ref.prototype.promise","type":"property","parent":"can-connect/can/ref/ref.Map.Ref.prototype","src":{"line":230,"codeLine":237,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"","types":[{"type":"Promise"}],"title":"promise","signatures":[{"code":"ref.promise","description":"\nReturns a promise if it has already been resolved, if not, returns a new promise.","params":[],"returns":{"types":[{"type":"Promise"}],"description":"\n\t "}}],"_curReturn":{"types":[{"type":"Promise"}],"description":"\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
