	...
	<div class="page-type">
		<h1>createdInstance</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L282">Edit on GitHub</a>
				</li>
...
<a href="../../constructor/store/store.stores.moveCreatedInstanceToInstanceStore.html" title="Moves recently created instances into the store.instanceStore.">moveCreatedInstanceToInstanceStore</a>
to ensure instances &quot;referenced&quot; before being created are moved into the
<a href="../../constructor/store/store.instanceStore.html" title="A store of instances mapped by base.id.">instanceStore</a>.</p>
