	...
	<div class="page-type">
		<h1>serializeList</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L97">Edit on GitHub</a>
				</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/map/map.serializeList","parent":"can-connect/can/map/map.serializers","src":{"line":96,"codeLine":106,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nCalls `list.serialize()`.\n","title":"serializeList","signatures":[{"code":"connection.serializeList( list )","description":"\n\n  Simply calls [can-define/list/list.prototype.serialize] on the underlying list.\n\t ","params":[]}],"pathToRoot":"../../../.."};
</script>
</article>
