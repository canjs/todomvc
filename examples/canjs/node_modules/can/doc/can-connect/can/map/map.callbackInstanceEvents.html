	...
	<ul>
					...
					<li class="current
						...
						<a class="function"
							...
							title="Dispatch events for instance callbacks, e.g. map.updatedInstance.">
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>callbackInstanceEvents</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L351">Edit on GitHub</a>
				</li>
    ...
    <p>Dispatch events for instance callbacks, e.g. <a href="map.updatedInstance.html" title="Updates the instance with the response from connection.updateData.">updatedInstance</a>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>canMapBehavior.callbackInstanceEvents( cbName, instance )</code>
  </h2>
  <p>Dispatches events in the end of instance callbacks. This static method could be useful for overriding
instance callbacks. E.g.: to override <code>updatedInstance</code> callback:</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>cbName</b> <code>{String}</code>: <p>Callback name prefix, e.g. (&quot;created&quot; | &quot;updated&quot; | &quot;destroyed&quot;) to form a string &quot;createdInstance&quot;, etc.</p>
</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/map/map.callbackInstanceEvents","parent":"can-connect/can/map/map.static","src":{"line":350,"codeLine":373,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nDispatch events for instance callbacks, e.g. [can-connect/can/map/map.updatedInstance].\n","title":"callbackInstanceEvents","signatures":[{"code":"canMapBehavior.callbackInstanceEvents( cbName, instance )","description":"\n\n  Dispatches events in the end of instance callbacks. This static method could be useful for overriding\n  instance callbacks. E.g.: to override `updatedInstance` callback:\n\n  ```\n  connect( [ canMap, {\n      updatedInstance: function( instance, props ) {\n          instance = smartMerge( instance, props );\n          canMapBehavior.callbackInstanceEvents( \"updated\", instance );\n      }\n  } ], {} )\n  ```\n","params":[{"types":[{"type":"String"}],"name":"cbName","description":"Callback name prefix, e.g. (\"created\" | \"updated\" | \"destroyed\") to form a string \"createdInstance\", etc."},{"types":[{"type":"Map"}],"name":"instance","description":"A Map instance.\n"}]}],"_curParam":{"types":[{"type":"Map"}],"name":"instance","description":"A Map instance.\n"},"pathToRoot":"../../../.."};
</script>
</article>
