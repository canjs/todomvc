	...
	<div class="page-type">
		<h1>Map</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L110">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Defaults to <a href="../../../can-types.DefaultMap.html" title="">DefaultMap</a> if a Map is
not specified.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":109,"codeLine":144,"path":"node_modules/can-connect/can/map/map.js"},"type":"property","description":"\nSpecify what type of `Map` should be hydrated.\n","types":[{"type":"Map","description":"Defaults to [can-types.DefaultMap] if a Map is\nnot specified.\n"}],"title":"Map","name":"can-connect/can/map/map._Map","parent":"can-connect/can/map/map.hydrators","comment":" ","pathToRoot":"../../../.."};
</script>
</article>
