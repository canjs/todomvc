	...
	<div class="page-type">
		<h1>serializeInstance</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/can/map/map.js#L84">Edit on GitHub</a>
				</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-connect/can/map/map.serializeInstance","parent":"can-connect/can/map/map.serializers","src":{"line":83,"codeLine":93,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nCalls `instance.serialize()`.\n","title":"serializeInstance","signatures":[{"code":"connection.serializeInstance( instance )","description":"\n\n  Simply calls [can-define/map/map.prototype.serialize] on the underlying map.\n\t ","params":[]}],"pathToRoot":"../../../.."};
</script>
</article>
