...
<p>Note that <a href="can/map/map.html" title="Make a connection use a map type.">can-connect/can/map/map</a> adds <code>destroy</code> to the <code>instance</code>
type's prototype.</p>
