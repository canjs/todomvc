...
<p>Note that <a href="can/map/map.html" title="Make a connection use a map type.">can-connect/can/map/map</a> adds <code>getList</code> to the <code>instance</code>'s
