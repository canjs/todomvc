	...
	<div class="page-type">
		<h1>destroyedData</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/callbacks-once/callbacks-once.js#L39">Edit on GitHub</a>
				</li>
