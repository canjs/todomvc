	...
	<div class="page-type">
		<h1>cidStore</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/constructor.js#L108">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>The <code>cidStore</code> is used to temporarily hold references to instances by <a href="../../can-util/js/cid/cid.html" title="Deprecated. Use can-cid instead.">cid</a> that don't
