...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>destroy</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js#L665">Edit on GitHub</a>
				</li>
    ...
    <p>Overwrites <a href="../../connection.destroy.html" title="Destroy an instance.">connection.destroy</a> so any
...
promise.then(function(){
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;instance&gt;}</code>: <p>The promise returned by the base connection's <a href="../../connection.destroy.html" title="Destroy an instance.">connection.destroy</a>.</p>
</p>
  </div>
