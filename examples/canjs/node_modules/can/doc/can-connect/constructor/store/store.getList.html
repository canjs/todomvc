...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>getList</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js#L561">Edit on GitHub</a>
				</li>
    ...
    <p>Overwrites <a href="../../connection.getList.html" title="Gets a can-connect.List of instances.">connection.getList</a> so any
...
and then decrements it after the request is complete.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;instance&gt;}</code>: <p>The promise returned by the base connection's <a href="../../connection.getList.html" title="Gets a can-connect.List of instances.">connection.getList</a>.</p>
</p>
  </div>
