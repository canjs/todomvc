	...
	<div class="page-type">
		<h1>createdInstance</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js#L243">Edit on GitHub</a>
				</li>
...
<div class="signature">
  ...
  <p>Calls the base behavior. Then calls <a href="store.stores.moveCreatedInstanceToInstanceStore.html" title="Moves recently created instances into the store.instanceStore.">moveCreatedInstanceToInstanceStore</a>.</p>
