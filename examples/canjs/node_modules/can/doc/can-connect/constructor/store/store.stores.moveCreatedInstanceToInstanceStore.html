...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>moveCreatedInstanceToInstanceStore</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/constructor/store/store.js#L263">Edit on GitHub</a>
				</li>
    ...
    <p>Moves recently created instances into the <a href="store.instanceStore.html" title="A store of instances mapped by base.id.">instanceStore</a>.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.createdInstance( instance )</code>
  </h2>
  <p>Checks if an instance has an <code>id</code> and is in the <code>newInstanceStore</code>. If it does, moves it into the
<a href="store.instanceStore.html" title="A store of instances mapped by base.id.">instanceStore</a>.</p>
...
being created, this will check for that condition and move this instance into the <a href="store.instanceStore.html" title="A store of instances mapped by base.id.">instanceStore</a>.</p>
</li>
