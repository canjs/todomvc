...
<div class="signature">
  ...
  <p>The <a href="constructor/constructor.html" title="Adds the ability to operate on special types instead of plain JavaScript Objects
and Arrays.">can-connect/constructor/constructor</a> behavior is typically
used to implement the core instance interface methods:</p>
<ul>
<li><a href="connection.getList.html" title="Gets a can-connect.List of instances.">connection.getList</a> - Get a list of instances.</li>
<li><a href="connection.get.html" title="">connection.get</a> - Get a single instance.</li>
<li><a href="connection.save.html" title="Create or update an instance.">connection.save</a> - Create or update an instance.</li>
<li><a href="connection.destroy.html" title="Destroy an instance.">connection.destroy</a> - Destroy an instance.</li>
</ul>
