	...
	<div class="page-type">
		<h1>ajax</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-connect/edit/master/data/url/url.js#L215">Edit on GitHub</a>
				</li>
...
ajax requests.  By default <a href="../../../can-util/dom/ajax/ajax.html" title="Make an asynchronous HTTP (AJAX) request.">ajax</a> provides the ajax
