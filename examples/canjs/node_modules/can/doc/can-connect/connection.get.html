...
<p>Note that <a href="can/map/map.html" title="Make a connection use a map type.">can-connect/can/map/map</a> adds <code>get</code> to the <code>instance</code>'s
