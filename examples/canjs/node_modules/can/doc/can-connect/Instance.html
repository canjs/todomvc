...
and Arrays.">can-connect/constructor/constructor</a> behavior is primarily responsible for
providing methods that go <a href="constructor/constructor.hydrateInstance.html" title="Makes a type object given raw data.">back</a> and
<a href="constructor/constructor.serializeInstance.html" title="Returns the serialized form of an instance.">forth</a> between
instances and raw data.  Other behaviors like <a href="can/map/map.html" title="Make a connection use a map type.">can-connect/can/map/map</a>
