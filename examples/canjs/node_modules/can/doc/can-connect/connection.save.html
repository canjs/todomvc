...
<a href="constructor/constructor.isNew.html" title="Returns if this instance has not been persisted.">isNew</a>.</p>
<p>Note that <a href="can/map/map.html" title="Make a connection use a map type.">can-connect/can/map/map</a> adds <code>save</code> to the <code>instance</code>
type's prototype.</p>
