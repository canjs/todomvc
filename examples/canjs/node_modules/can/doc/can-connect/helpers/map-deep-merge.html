...
<head>
	<meta charset="utf-8">
	<title>CanJS - can-connect/helpers/map-deep-merge</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-connect/helpers/map-deep-merge</h1>
...
method.  If one does not exist, <code>new Type(props)</code> is used instead.</p>
  ...
  <div class="parameters">
    ...
    <section class="body">
    <h2>Use</h2>
<p>This method is often used by mixing in the <a href="../can/merge/merge.html" title="Update nested data structures correctly with the response from the server.">can-connect/can/merge/merge</a> behavior
into a connection.</p>
