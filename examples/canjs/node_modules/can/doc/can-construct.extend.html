...
created and return an existing one from your cache store (e.g. using <a href="can-connect/constructor/store/store.html" title="Supports saving and retrieving lists and instances in a store.">can-connect/constructor/store/store</a>).</p>
