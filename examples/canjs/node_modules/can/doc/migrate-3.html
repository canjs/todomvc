...
is initialized with values specified by the component element’s data bindings.">ViewModel</a>. To restore the behavior in 2.x, simply set <a href="can-component.prototype.leakScope.html" title="Allow reading the outer scope values from a component’s view and a component’s viewModel values in the user content.">leakScope</a> to be <code>true</code> on the component:</p>
...
<ul>
<li>Include a Promise polyfill if targeting browsers that do not have native support. <a href="https://stealjs.com/">Steal</a> includes a polyfill for you.</li>
...
<li><code>can/view/href/href</code> — <a href="can-view-href.html" title="Sets an element’s href attribute so that its url will set the specified attribute values on can-route.">can-view-href</a></li>
