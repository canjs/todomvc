	...
	<div class="page-type">
		<h1>getKeyDependencies</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/observe/observe.js#L160">Edit on GitHub</a>
				</li>
...
Otherwise returns an object with up to two keys: <code>keyDependencies</code> is a <a href="../can-util/js/cid-map/cid-map.html" title="Exports the native Map
or a polyfill.">CIDMap</a> that
maps each Map-like object providing keyed values to an Array of the relevant keys; <code>valueDependencies</code> is a
<a href="../can-util/js/cid-set/cid-set.html" title="Exports the native Set
or a polyfill.">CIDSet</a> that contains all Value-like dependencies providing their own values.</p>
