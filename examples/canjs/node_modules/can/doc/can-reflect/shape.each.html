	...
	<div class="page-type">
		<h1>each</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-reflect/edit/master/reflections/shape/shape.js#L176">Edit on GitHub</a>
				</li>
...
iterating over every Number and String key on <code>obj</code> and calling <code>callback</code> on each one.</p>
