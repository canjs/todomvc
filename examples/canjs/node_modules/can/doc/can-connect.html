	...
	<ul>
					...
					<li class="
						...
						<a class="module"
							...
							title="Always check the store.instanceStore when creating new instances of the connected map._Map type.">
					...
					<li class="
						...
						<a class="module"
							...
							title="Update nested data structures correctly with the response from the server.">
							./can/merge/
						</a>
...
<li><a href="can-connect/can/model/model.html" title="Exports a constructor that works very similar to can.Model.">can-connect/can/model/model</a> — Inherit from a highly compatible <a href="http://v2.canjs.com/docs/can.Model.html">can.Model</a> implementation.</li>
...
<h2>Overview</h2>
<p>The <code>can-connect</code> module exports a <code>connect</code> function that is used to assemble different
...
<li><a href="can-connect/connection.getList.html" title="Gets a can-connect.List of instances.">connection.getList</a></li>
<li><a href="can-connect/connection.save.html" title="Create or update an instance.">connection.save</a></li>
<li><a href="can-connect/connection.destroy.html" title="Destroy an instance.">connection.destroy</a></li>
</ul>
...
extend, or require some set of <a href="#Interfaces">interfaces</a>.  For example, <a href="can-connect/data/url/url.html" title="">can-connect/data/url/url</a> implements
...
a map.">can-connect/can/super-map/super-map</a> helper to create a connection that bundles <a href="can-connect/can/map/map.html" title="Make a connection use a map type.">can/map</a> and
...
a connection with React’s observable life-cycle. Read more <a href="#Otheruse">here</a>.</p>
<h3>Angular use</h3>
<p>Help us create a special AngularJS behavior that integrates
a connection with Angular’s observable life-cycle. Read more <a href="#Otheruse">here</a>.</p>
<h3>Backbone use</h3>
<p>Help us create a special BackboneJS behavior that integrates
a connection with Backbone’s observable life-cycle. Read more <a href="#Otheruse">here</a>.</p>
<h3>Other use</h3>
...
<ul>
<li><a href="can-connect/constructor/store/store.addInstanceReference.html" title="Adds a reference to an instance so it can be easily looked up.">addInstanceReference</a> — when an instance is being used.</li>
<li><a href="can-connect/constructor/store/store.deleteInstanceReference.html" title="Removes a reference to an instance by base.id so it can be garbage collected.">deleteInstanceReference</a> — when an instance is no longer being used.</li>
<li><a href="can-connect/constructor/store/store.addListReference.html" title="Adds a reference to a list so it can be easily looked up.">addListReference</a> — when a list is being used.</li>
<li><a href="can-connect/constructor/store/store.deleteListReference.html" title="Removes a reference to a list by base.listSet so it can be garbage collected.">deleteListReference</a> — when a list is no longer being used.</li>
</ul>
<h2>Interfaces</h2>
...
<code>.createdData( props, params, cid) -&gt; props</code> - An instance’s data is created.
<code>.updatedData( props, params) -&gt; props</code> - An instance’s data is updated.
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-connect/can-connect.md"},"description":"`can-connect` provides persisted data middleware. Use it to assemble powerful model layers for any JavaScript project.\n\n","type":"module","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-connect","parent":"can-core","outline":"2","package":{"author":{"name":"Bitovi"},"bugs":{"url":"https://github.com/canjs/can-connect/issues"},"dependencies":{"can-compute":"^3.1.0","can-construct":"^3.2.0","can-define":"^1.2.0","can-event":"^3.5.0","can-list":"^3.1.0","can-make-rest":"0.1.1","can-map":"^3.1.0","can-namespace":"1.0.0","can-observation":"^3.2.0","can-reflect":"^1.2.0","can-set":"^1.3.0","can-stache":"^3.1.0","can-stache-bindings":"^3.2.0","can-types":"^1.1.0","can-util":"^3.9.0","can-validate-interface":"0.1.0","can-view-callbacks":"^3.1.0","can-view-nodelist":"^3.1.0","steal-stache":"^3.1.0"},"description":"Data connection middleware and utilities","devDependencies":{"can-fixture":"^1.1.0","jquery":"2.x - 3.x","jshint":"^2.9.4","steal":"^1.0.1","steal-css":"^1.0.0","steal-qunit":"^1.0.0","steal-tools":"^1.0.0","testee":"^0.3.0"},"directories":{},"dist":{"shasum":"b349d2e1138e80b7f778aec7bc0960b52559abb8","tarball":"https://registry.npmjs.org/can-connect/-/can-connect-1.5.3.tgz"},"engines":{"npm":"^3.0.0"},"gitHead":"0edf7b89bd9fdc8eb737b8f059bd4a5621158855","homepage":"https://github.com/canjs/can-connect#readme","keywords":["CanJS"],"license":"MIT","main":"can-connect.js","maintainers":[{"email":"brad@bitovi.com","name":"bmomberger-bitovi"},{"email":"daff@neyeon.de","name":"daffl"},{"email":"fadeev.ilya@gmail.com","name":"ilyavf"},{"email":"justin@bitovi.com","name":"justinbmeyer"},{"email":"kyle@kylegifford.com","name":"kylegifford"},{"email":"marshall@creativeideal.net","name":"marshallswain"},{"email":"matthew@matthewphillips.info","name":"matthewp"},{"email":"nlundqu@gmail.com","name":"nlundquist"},{"email":"kphillips86@gmail.com","name":"phillipskevin"}],"name":"can-connect","optionalDependencies":{},"repository":{"type":"git","url":"git+https://github.com/canjs/can-connect.git"},"scripts":{"build":"node build.js","jshint":"jshint --config .jshintrc","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run jshint && testee --browsers firefox test/test.html","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"plugins":["steal-stache","steal-css"]},"version":"1.5.3"},"signatures":[{"code":"connect(behaviors, options)","description":"\n\nGoes through every behavior and assembles them into a final\nconnection.\n\n```js\nvar connect = require(\"can-connect\");\nvar todosConnection = connect([\n    require(\"can-connect/data/url/url\"),\n    require(\"can-connect/constructor/constructor\")    \n],{\n    url: \"/api/todos\"\n});\n```\n","params":[{"types":[{"type":"Array","template":[{"types":[{"type":"can-connect/Behavior"}]}]}],"name":"behaviors","description":"An array of\nbehaviors that will be used to compose the final connection.\n"},{"types":[{"type":"Object","options":[]}],"name":"options","description":"an object of configuration\noptions.\n"}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"options","description":"an object of configuration\noptions.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
