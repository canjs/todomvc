	...
	<div class="page-type">
		<h1>cid-set</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/cid-set/cid-set.md">Edit on GitHub</a>
				</li>
