...
<!--####################################################################
	...
	@function can-util/js/dev/dev.error
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="dev.error.html">error</a></li>
	...
	<div class="page-type">
		<h1>error</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/dev/dev.js#L86">Edit on GitHub</a>
				</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-util/js/dev/dev.error","parent":"can-util/js/dev/dev","src":{"line":85,"codeLine":101,"path":"node_modules/can-util/js/dev/dev.js"},"description":" \nAdds an error message to the console.\n\n```\nvar dev = require(\"can-util/js/dev/dev\");\n\ndev.error(new Error(\"Oh no!\"));\n```\n\n","title":"error","signatures":[{"code":"dev.error(err)","description":"","params":[{"types":[{"type":"String"},{"type":"Error"}],"name":"err","description":"The error to be logged.\n "}]}],"_curParam":{"types":[{"type":"String"},{"type":"Error"}],"name":"err","description":"The error to be logged.\n "},"pathToRoot":"../../../.."};
</script>
</article>
