	...
	<div class="page-type">
		<h1>log</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/log/log.js#L43">Edit on GitHub</a>
				</li>
...
<script type="text/javascript">
  window.docObject = {"type":"function","name":"can-util/js/log/log.log","parent":"can-util/js/log/log","src":{"line":42,"codeLine":57,"path":"node_modules/can-util/js/log/log.js"},"description":" Adds a message to the console.\n\n```\nvar canLog = require(\"can-util/js/log/log\");\n\ncanLog.log(\"hi\");\n```\n\n","title":"log","signatures":[{"code":"canLog.log(msg)","description":"","params":[{"types":[{"type":"String"}],"name":"msg","description":"the message\n"}]}],"_curParam":{"types":[{"type":"String"}],"name":"msg","description":"the message\n"},"pathToRoot":"../../../.."};
</script>
</article>
