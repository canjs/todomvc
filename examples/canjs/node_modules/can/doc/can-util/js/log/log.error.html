	...
	<div class="page-type">
		<h1>error</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/log/log.js#L70">Edit on GitHub</a>
				</li>
...
<pre><code>var canLog = require(&quot;can-util/js/log/log&quot;);
