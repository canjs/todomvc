	...
	<div class="page-type">
		<h1>cid-map</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/js/cid-map/cid-map.md">Edit on GitHub</a>
				</li>
...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-util/js/cid-map/cid-map.md"},"description":"\nExports the native [Map](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map)\nor a polyfill.\n","type":"module","title":"cid-map","types":[{"type":"Map"}],"name":"can-util/js/cid-map/cid-map","parent":"can-util/js","comment":" ","pathToRoot":"../../../.."};
</script>
</article>
