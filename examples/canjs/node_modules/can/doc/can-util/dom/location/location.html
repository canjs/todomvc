...
<!--####################################################################
	...
	@module can-util/dom/location/location
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>location</b> <code>{Object}</code>: <p>An optional location-like object
to set as the context's location</p>
<p>Optionally sets, and returns, the location object for the context.</p>
...
<script type="text/javascript">
  window.docObject = {"src":{"line":4,"codeLine":23,"path":"node_modules/can-util/dom/location/location.js"},"type":"module","description":"","title":"location","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-util/dom/location/location","parent":"can-util/dom","signatures":[{"code":"location(location)","description":"\n","params":[{"types":[{"type":"Object","options":[]}],"name":"location","description":"An optional location-like object\nto set as the context's location\n\nOptionally sets, and returns, the location object for the context.\n\n```js\nvar locationShim = { path: '/' };\nvar LOCATION = require(\"can-util/dom/location/location\");\nLOCATION(locationShim);\n\n...\nLOCATION().path; // -> '/'\n```\n"}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"location","description":"An optional location-like object\nto set as the context's location\n\nOptionally sets, and returns, the location object for the context.\n\n```js\nvar locationShim = { path: '/' };\nvar LOCATION = require(\"can-util/dom/location/location\");\nLOCATION(locationShim);\n\n...\nLOCATION().path; // -> '/'\n```\n"},"pathToRoot":"../../../.."};
</script>
</article>
