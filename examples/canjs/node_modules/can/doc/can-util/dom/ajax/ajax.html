	...
	<div class="page-type">
		<h1>ajax</h1>
			<ul class="title-social">
				...
				<li>
					<a class="button-link" href="//github.com/canjs/can-util/edit/master/dom/ajax/ajax.js#L9">Edit on GitHub</a>
				</li>
...
<pre><code>var ajax = require(&quot;can-util/dom/ajax/ajax&quot;);
...
<li><strong>data</strong> <code>{Object}</code> The data of the request. If data needs to be urlencoded (e.g. for GET requests or for CORS) it is serialized with [can-util/js/param].</li>
