...
<script type="text/javascript">
  window.docObject = {"src":{"path":"node_modules/can-map-backup/doc/can-map-backup.md"},"description":"\n","type":"module","title":"","types":[{"type":"can-map"}],"name":"can-map-backup","parent":"can-legacy","test":"src/test/test.html","package":{"author":{"email":"contact@bitovi.com","name":"Bitovi","url":"http://bitovi.com"},"dependencies":{"can-compute":"^3.1.0-pre.9","can-connect":"^1.5.0-pre.0","can-fixture":"^1.1.0-pre.0","can-jquery":"^3.1.0-pre.0","can-list":"^3.1.0-pre.9","can-map":"^3.1.0-pre.10","can-set":"^1.3.0-pre.0","can-util":"^3.9.0-pre.4"},"description":"Backup and restore a Maps state","devDependencies":{"can-map-define":"^3.1.0-pre.0","documentjs":"^0.4.2","done-ssr":"^1.0.4","donejs-cli":"^1.0.1","generator-donejs":"^1.0.5","jshint":"^2.9.1","steal":"^1.2.9","steal-qunit":"^1.0.1","steal-tools":"^1.1.2","testee":"^0.6.0"},"directories":{},"dist":{"integrity":"sha512-D55YKAai7EVXI0fPVSyEleMa6Szok3P0YE2ATXXiPHGxO3JtvE838QU+sf3yTdfbBlQFVJQ+WIDQchHlcV2AlQ==","shasum":"d61651080ac9849dcbef528f24a5a194c1687085","tarball":"https://registry.npmjs.org/can-map-backup/-/can-map-backup-3.1.0.tgz"},"gitHead":"d0f207aefb3368138ead1bd1757ee92a3d080572","homepage":"https://canjs.com","keywords":["canjs"],"main":"can-map-backup","maintainers":[{"email":"kphillips86@gmail.com","name":"phillipskevin"},{"email":"marshall@creativeideal.net","name":"marshallswain"},{"email":"ivan.herndon@gmail.com","name":"iherndon"},{"email":"matthew@matthewphillips.info","name":"matthewp"},{"email":"daff@neyeon.de","name":"daffl"},{"email":"justin@bitovi.com","name":"justinbmeyer"}],"name":"can-map-backup","optionalDependencies":{},"scripts":{"build":"node build.js","develop":"can-serve --static --develop --port 8080","document":"documentjs","jshint":"jshint *.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish --tag=pre","test":"npm run jshint && npm run testee","testee":"testee test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"steal":{"configDependencies":["live-reload"],"main":"can-map-backup","npmIgnore":["documentjs","testee","generator-donejs","donejs-cli","steal-tools"]},"version":"3.1.0"},"signatures":[{"code":"require('can-map-backup')","description":"\n\nAdds a [can-map-backup/can-map.prototype.backup],\n[can-map-backup/can-map.prototype.isDirty] and\n[can-map-backup/can-map.prototype.restore] method to [can-map].\n","params":[],"returns":{"types":[{"type":"can-map"}],"description":"Exports [can-map].\n"}}],"_curReturn":{"types":[{"type":"can-map"}],"description":"Exports [can-map].\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
